...
namespace System.Management.Instrumentation
{
	...
	internal class SchemaMapping
	{
		...
		// (get) Token: 0x06000516 RID: 1302 RVA: 0x000243EE File Offset: 0x000225EE
		...
		// (get) Token: 0x06000517 RID: 1303 RVA: 0x000243F6 File Offset: 0x000225F6
		...
		// (get) Token: 0x06000518 RID: 1304 RVA: 0x000243FE File Offset: 0x000225FE
		...
		// (get) Token: 0x06000519 RID: 1305 RVA: 0x00024406 File Offset: 0x00022606
		...
		// (get) Token: 0x0600051A RID: 1306 RVA: 0x0002440E File Offset: 0x0002260E
		...
		// (get) Token: 0x0600051B RID: 1307 RVA: 0x00024416 File Offset: 0x00022616
		...
		// (get) Token: 0x0600051C RID: 1308 RVA: 0x0002441E File Offset: 0x0002261E
		...
		// Token: 0x0600051D RID: 1309 RVA: 0x00024426 File Offset: 0x00022626
		public static void ThrowUnsupportedMember(MemberInfo mi)
		{
			SchemaMapping.ThrowUnsupportedMember(mi, null);
		}

		// Token: 0x0600051E RID: 1310 RVA: 0x0002442F File Offset: 0x0002262F
		...
		// Token: 0x0600051F RID: 1311 RVA: 0x00024454 File Offset: 0x00022654
		public SchemaMapping(Type type, SchemaNaming naming, Hashtable mapTypeToConverterClassName)
		{
			...
			foreach (MemberInfo memberInfo in type.GetMembers())
			{
				if ((memberInfo is FieldInfo || memberInfo is PropertyInfo) && memberInfo.GetCustomAttributes(typeof(IgnoreMemberAttribute), false).Length == 0)
				{
					...
					string text3 = "prop_" + num.ToString();
					string text4 = "handle_" + num++.ToString();
