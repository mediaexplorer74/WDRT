	...
	internal class Resources
	{
		...
		internal static ResourceManager ResourceManager
		{
			get
			{
				...
				{
					Resources.resourceMan = new ResourceManager("Microsoft.WindowsDeviceRecoveryTool.TrinityAdaptation.Properties.Resources", typeof(Resources).Assembly);
				}
		...
		internal static Bitmap Neo_Device_front
		{
			get
			{
				return (Bitmap)Resources.ResourceManager.GetObject("Neo_Device_front", Resources.resourceCulture);
			}
		}
		...
		internal static Bitmap Neo_Logo
		{
			get
			{
				return (Bitmap)Resources.ResourceManager.GetObject("Neo_Logo", Resources.resourceCulture);
			}
		}
