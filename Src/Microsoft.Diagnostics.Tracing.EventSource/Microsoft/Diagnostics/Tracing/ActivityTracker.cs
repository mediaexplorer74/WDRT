				...
				checked
				{
					fixed (Guid* ptr = &idRet)
					{
						...
						else
						{
							...
							num = ActivityTracker.ActivityInfo.AddIdToGuid(ptr, num, (uint)domainID, false);
						}
						activityPathGuidOffset = ActivityTracker.ActivityInfo.AddIdToGuid(ptr, num, (uint)this.m_uniqueId, false);
