...
namespace Microsoft.WindowsPhone.ImageUpdate.Tools.Common
{
	...
	public class AmbiguousArgumentException : ParseException
	{
		...
		public AmbiguousArgumentException(string id1, string id2)
			: base(string.Format(CultureInfo.InvariantCulture, "Defined arguments '{0}' and '{1}' are ambiguous", new object[] { id1, id2 }))
		{
		}

		// Token: 0x06000085 RID: 133 RVA: 0x00005880 File Offset: 0x00003A80
		public AmbiguousArgumentException(string id1)
			: base(string.Format(CultureInfo.InvariantCulture, "Defined argument '{0}' is ambiguous", new object[] { id1 }))
		{
		}
