...
namespace Microsoft.WindowsAzure.Storage.RetryPolicies
{
	...
	public sealed class LinearRetry : IExtendedRetryPolicy, IRetryPolicy
	{
		...
		public RetryInfo Evaluate(RetryContext retryContext, OperationContext operationContext)
		{
			...
			TimeSpan timeSpan;
			if (this.ShouldRetry(retryContext.CurrentRetryCount, flag ? 500 : retryContext.LastRequestResult.HttpStatusCode, retryContext.LastRequestResult.Exception, out timeSpan, operationContext))
			{
				...
				{
					TimeSpan timeSpan2 = CommonUtility.MaxTimeSpan(DateTimeOffset.Now - dateTimeOffset.Value, TimeSpan.Zero);
					retryInfo.RetryInterval = timeSpan - timeSpan2;
				}
				else
				{
