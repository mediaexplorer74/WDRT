...
namespace System.Management
{
	...
	{
		// Token: 0x060002EC RID: 748 RVA: 0x00010734 File Offset: 0x0000E934
		public ManagementClassGenerator()
		{
		}

		// Token: 0x060002ED RID: 749 RVA: 0x00010848 File Offset: 0x0000EA48
		public ManagementClassGenerator(ManagementClass cls)
		{
			this.classobj = cls;
		}

		// Token: 0x060002EE RID: 750 RVA: 0x00010960 File Offset: 0x0000EB60
		...
		// Token: 0x060002EF RID: 751 RVA: 0x00010994 File Offset: 0x0000EB94
		...
		// Token: 0x060002F0 RID: 752 RVA: 0x00010A00 File Offset: 0x0000EC00
		...
		// Token: 0x060002F1 RID: 753 RVA: 0x00010A6F File Offset: 0x0000EC6F
		...
		// Token: 0x060002F2 RID: 754 RVA: 0x00010A8C File Offset: 0x0000EC8C
		...
		// Token: 0x060002F3 RID: 755 RVA: 0x00010F94 File Offset: 0x0000F194
		...
		// Token: 0x060002F4 RID: 756 RVA: 0x00011030 File Offset: 0x0000F230
		...
		// Token: 0x060002F5 RID: 757 RVA: 0x000111E0 File Offset: 0x0000F3E0
		...
		// Token: 0x060002F6 RID: 758 RVA: 0x00011718 File Offset: 0x0000F918
		...
		// Token: 0x060002F7 RID: 759 RVA: 0x00011A74 File Offset: 0x0000FC74
		...
		// Token: 0x060002F8 RID: 760 RVA: 0x00011B94 File Offset: 0x0000FD94
		...
		// Token: 0x060002F9 RID: 761 RVA: 0x00011D24 File Offset: 0x0000FF24
		...
		// Token: 0x060002FA RID: 762 RVA: 0x00011DF4 File Offset: 0x0000FFF4
		...
		// Token: 0x060002FB RID: 763 RVA: 0x00011FA8 File Offset: 0x000101A8
		...
		// Token: 0x060002FC RID: 764 RVA: 0x00012174 File Offset: 0x00010374
		...
		// Token: 0x060002FD RID: 765 RVA: 0x00012550 File Offset: 0x00010750
		...
		// Token: 0x060002FE RID: 766 RVA: 0x00012940 File Offset: 0x00010B40
		...
		// Token: 0x060002FF RID: 767 RVA: 0x000136C0 File Offset: 0x000118C0
		...
		// Token: 0x06000300 RID: 768 RVA: 0x00013BFC File Offset: 0x00011DFC
		...
		// Token: 0x06000301 RID: 769 RVA: 0x00014230 File Offset: 0x00012430
		private void GenerateConstructPath()
		{
			...
			else
			{
				...
				for (int j = 0; j < this.arrKeys.Count; j++)
				{
					...
					{
						string text3 = "key";
						object obj = this.arrKeys[j];
						CodeMethodInvokeExpression codeMethodInvokeExpression = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text3 + ((obj != null) ? obj.ToString() : null)), new CodePrimitiveExpression("\""));
						...
						{
							string text4 = ",";
							object obj2 = this.arrKeys[j];
							obj3 = text4 + ((obj2 != null) ? obj2.ToString() : null) + "=";
						}
						else
						{
							string text5 = ".";
							object obj4 = this.arrKeys[j];
							obj3 = text5 + ((obj4 != null) ? obj4.ToString() : null) + "=";
						}
						CodeMethodInvokeExpression codeMethodInvokeExpression3 = ManagementClassGenerator.GenerateConcatStrings(new CodePrimitiveExpression(obj3), codeMethodInvokeExpression2);
					...
					{
						this.cmie = new CodeMethodInvokeExpression();
						CodeMethodReferenceExpression method = this.cmie.Method;
						CodeTypeReference codeTypeReference = new CodeTypeReference(((CodeTypeReference)this.arrKeyType[j]).BaseType + " ");
						string text6 = "key";
						object obj5 = this.arrKeys[j];
						method.TargetObject = new CodeCastExpression(codeTypeReference, new CodeVariableReferenceExpression(text6 + ((obj5 != null) ? obj5.ToString() : null)));
						this.cmie.Method.MethodName = "ToString";
						object obj7;
						if (j != 0)
						{
							string text7 = ",";
							object obj6 = this.arrKeys[j];
							obj7 = text7 + ((obj6 != null) ? obj6.ToString() : null) + "=";
						}
						else
						{
							string text8 = ".";
							object obj8 = this.arrKeys[j];
							obj7 = text8 + ((obj8 != null) ? obj8.ToString() : null) + "=";
						}
						CodeMethodInvokeExpression codeMethodInvokeExpression5 = ManagementClassGenerator.GenerateConcatStrings(new CodePrimitiveExpression(obj7), this.cmie);
		...
		// Token: 0x06000302 RID: 770 RVA: 0x000145B8 File Offset: 0x000127B8
		...
		// Token: 0x06000303 RID: 771 RVA: 0x0001475C File Offset: 0x0001295C
		private void GenerateConstructorWithKeys()
		{
			if (this.arrKeyType.Count > 0)
			{
				...
				for (int j = 0; j < this.arrKeys.Count; j++)
				{
					CodeExpressionCollection parameters = this.cmie.Parameters;
					string text = "key";
					object obj = this.arrKeys[j];
					parameters.Add(new CodeVariableReferenceExpression(text + ((obj != null) ? obj.ToString() : null)));
				}
				this.coce = new CodeObjectCreateExpression();
				this.coce.CreateType = new CodeTypeReference(this.PublicNamesUsed["PathClass"].ToString());
				this.coce.Parameters.Add(this.cmie);
		...
		// Token: 0x06000304 RID: 772 RVA: 0x00014A68 File Offset: 0x00012C68
		...
		// Token: 0x06000305 RID: 773 RVA: 0x00014DEC File Offset: 0x00012FEC
		...
		// Token: 0x06000306 RID: 774 RVA: 0x00014F08 File Offset: 0x00013108
		...
		// Token: 0x06000307 RID: 775 RVA: 0x00015038 File Offset: 0x00013238
		...
		// Token: 0x06000308 RID: 776 RVA: 0x0001518C File Offset: 0x0001338C
		...
		// Token: 0x06000309 RID: 777 RVA: 0x00015348 File Offset: 0x00013548
		...
		// Token: 0x0600030A RID: 778 RVA: 0x000154E4 File Offset: 0x000136E4
		...
		// Token: 0x0600030B RID: 779 RVA: 0x000156D8 File Offset: 0x000138D8
		...
		// Token: 0x0600030C RID: 780 RVA: 0x00015864 File Offset: 0x00013A64
		...
		// Token: 0x0600030D RID: 781 RVA: 0x00015B90 File Offset: 0x00013D90
		...
		// Token: 0x0600030E RID: 782 RVA: 0x00015E90 File Offset: 0x00014090
		...
		// Token: 0x0600030F RID: 783 RVA: 0x00016360 File Offset: 0x00014560
		...
		// Token: 0x06000310 RID: 784 RVA: 0x000178C8 File Offset: 0x00015AC8
		...
		// Token: 0x06000311 RID: 785 RVA: 0x00017A00 File Offset: 0x00015C00
		...
		// Token: 0x06000312 RID: 786 RVA: 0x00017B30 File Offset: 0x00015D30
		...
		// Token: 0x06000313 RID: 787 RVA: 0x00017C60 File Offset: 0x00015E60
		...
		// Token: 0x06000315 RID: 789 RVA: 0x00018418 File Offset: 0x00016618
		...
		// Token: 0x06000316 RID: 790 RVA: 0x000185A4 File Offset: 0x000167A4
		...
		// Token: 0x06000317 RID: 791 RVA: 0x00018728 File Offset: 0x00016928
		...
		// Token: 0x06000318 RID: 792 RVA: 0x00018C90 File Offset: 0x00016E90
		...
		// Token: 0x06000319 RID: 793 RVA: 0x00018CA0 File Offset: 0x00016EA0
		...
		// Token: 0x0600031A RID: 794 RVA: 0x00018D50 File Offset: 0x00016F50
		...
		// Token: 0x0600031B RID: 795 RVA: 0x00019EB4 File Offset: 0x000180B4
		...
		// Token: 0x0600031C RID: 796 RVA: 0x0001A5FC File Offset: 0x000187FC
		...
		// Token: 0x0600031D RID: 797 RVA: 0x0001A9B4 File Offset: 0x00018BB4
		...
		// Token: 0x0600031E RID: 798 RVA: 0x0001A9F0 File Offset: 0x00018BF0
		...
		// Token: 0x0600031F RID: 799 RVA: 0x0001AB64 File Offset: 0x00018D64
		...
		// (get) Token: 0x06000320 RID: 800 RVA: 0x0001ABD9 File Offset: 0x00018DD9
		...
		// (get) Token: 0x06000321 RID: 801 RVA: 0x0001ABE1 File Offset: 0x00018DE1
		...
		// Token: 0x06000323 RID: 803 RVA: 0x0001ACB8 File Offset: 0x00018EB8
		...
		// Token: 0x06000324 RID: 804 RVA: 0x0001AD70 File Offset: 0x00018F70
		...
		// Token: 0x06000325 RID: 805 RVA: 0x0001ADA8 File Offset: 0x00018FA8
		...
		// Token: 0x06000326 RID: 806 RVA: 0x0001AFAC File Offset: 0x000191AC
		...
		// Token: 0x06000327 RID: 807 RVA: 0x0001AFC0 File Offset: 0x000191C0
		...
		// Token: 0x06000328 RID: 808 RVA: 0x0001B3BC File Offset: 0x000195BC
		private static int ConvertBitMapValueToInt32(string bitMap)
		{
			...
			if (bitMap.StartsWith(text, StringComparison.Ordinal) || bitMap.StartsWith(text.ToUpper(CultureInfo.InvariantCulture), StringComparison.Ordinal))
			{
				...
				num = System.Convert.ToInt32(text, (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(int)));
			}
			else
			{
				num = System.Convert.ToInt32(bitMap, (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(int)));
			}
			return num;
		}

		// Token: 0x06000329 RID: 809 RVA: 0x0001B46C File Offset: 0x0001966C
		...
		// Token: 0x0600032A RID: 810 RVA: 0x0001B581 File Offset: 0x00019781
		...
		// Token: 0x0600032B RID: 811 RVA: 0x0001B594 File Offset: 0x00019794
		...
		// Token: 0x0600032C RID: 812 RVA: 0x0001B5B4 File Offset: 0x000197B4
		...
		// Token: 0x0600032D RID: 813 RVA: 0x0001B614 File Offset: 0x00019814
		...
		// Token: 0x0600032E RID: 814 RVA: 0x0001B6B8 File Offset: 0x000198B8
		...
		// Token: 0x0600032F RID: 815 RVA: 0x0001B731 File Offset: 0x00019931
		private static string GetString(string strToGet)
		{
			return RC.GetString(strToGet);
		}

		// Token: 0x06000330 RID: 816 RVA: 0x0001B73C File Offset: 0x0001993C
		...
		// Token: 0x06000331 RID: 817 RVA: 0x0001BB10 File Offset: 0x00019D10
		...
		// Token: 0x06000332 RID: 818 RVA: 0x0001BE64 File Offset: 0x0001A064
		...
		// Token: 0x06000333 RID: 819 RVA: 0x0001C380 File Offset: 0x0001A580
		...
		// Token: 0x06000334 RID: 820 RVA: 0x0001C81C File Offset: 0x0001AA1C
		...
		// Token: 0x06000335 RID: 821 RVA: 0x0001CA70 File Offset: 0x0001AC70
		...
		// Token: 0x06000336 RID: 822 RVA: 0x0001CC5C File Offset: 0x0001AE5C
		...
		// Token: 0x06000337 RID: 823 RVA: 0x0001CD5C File Offset: 0x0001AF5C
		...
		// Token: 0x06000338 RID: 824 RVA: 0x0001D08C File Offset: 0x0001B28C
		...
		// Token: 0x06000339 RID: 825 RVA: 0x0001D2B0 File Offset: 0x0001B4B0
		...
		// Token: 0x0600033A RID: 826 RVA: 0x0001D7A0 File Offset: 0x0001B9A0
		...
		// Token: 0x0600033B RID: 827 RVA: 0x0001D8A8 File Offset: 0x0001BAA8
		...
		// Token: 0x0600033C RID: 828 RVA: 0x0001DCAC File Offset: 0x0001BEAC
		...
		// Token: 0x0600033D RID: 829 RVA: 0x0001DDD2 File Offset: 0x0001BFD2
		...
		// Token: 0x0600033E RID: 830 RVA: 0x0001DDE0 File Offset: 0x0001BFE0
		...
		// Token: 0x0600033F RID: 831 RVA: 0x0001DDF0 File Offset: 0x0001BFF0
		...
		// Token: 0x06000340 RID: 832 RVA: 0x0001EC30 File Offset: 0x0001CE30
		...
		// Token: 0x06000341 RID: 833 RVA: 0x0001ED28 File Offset: 0x0001CF28
		...
		// Token: 0x06000342 RID: 834 RVA: 0x0001F624 File Offset: 0x0001D824
		...
		// Token: 0x06000343 RID: 835 RVA: 0x00020068 File Offset: 0x0001E268
		...
		// Token: 0x06000344 RID: 836 RVA: 0x00020120 File Offset: 0x0001E320
		...
		// Token: 0x06000345 RID: 837 RVA: 0x000209DC File Offset: 0x0001EBDC
		...
		// Token: 0x06000346 RID: 838 RVA: 0x00020A98 File Offset: 0x0001EC98
		...
		// Token: 0x06000347 RID: 839 RVA: 0x00020AD8 File Offset: 0x0001ECD8
		...
		// Token: 0x06000348 RID: 840 RVA: 0x00020B90 File Offset: 0x0001ED90
