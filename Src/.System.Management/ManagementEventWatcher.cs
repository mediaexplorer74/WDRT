...
namespace System.Management
{
	...
	public class ManagementEventWatcher : Component
	{
			...
			lock (this)
			{
				...
				try
				{
					...
					if (num >= 0)
					{
						...
						if (num >= 0)
						{
							managementBaseObject = new ManagementBaseObject(this.cachedObjects[(int)this.cacheIndex]);
							this.cacheIndex += 1U;
						}
					}
				}
		...
		// Token: 0x0600007F RID: 127 RVA: 0x0000463C File Offset: 0x0000283C
		private void StopInternal(bool inEventWatcherFinalizer)
		{
			...
			if (this.sink != null)
			{
				this.sink.CancelInternal(inEventWatcherFinalizer);
				this.sink = null;
			}
		}

		// Token: 0x06000080 RID: 128 RVA: 0x0000469C File Offset: 0x0000289C
		...
		// Token: 0x06000081 RID: 129 RVA: 0x00004758 File Offset: 0x00002958
		...
		// Token: 0x06000082 RID: 130 RVA: 0x0000478C File Offset: 0x0000298C
