...
internal class <Module>
{
	...
	internal unsafe static void ATL.CAtlComModule.Term(CAtlComModule* A_0)
	{
		if (*A_0 != 0)
		{
			...
			if (ptr < *(A_0 + 12))
			{
				do
				{
					...
					if (num != 0U)
					{
						...
						{
							uint num3 = num2;
							uint num4 = calli(System.UInt32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvStdcall)(System.IntPtr), (IntPtr)num3, (IntPtr)(*(*num3 + 8)));
						}
	...
	internal static void ?A0xea60aed3.??__E_AtlReleaseManagedClassFactories@ATL@@YMXXZ()
	{
	...
	internal static void ?A0xea60aed3.??__F_AtlReleaseManagedClassFactories@ATL@@YMXXZ()
	{
		<Module>.ATL.CAtlComModule.Term(ref <Module>.ATL._AtlComModule);
	}

	// Token: 0x06000004 RID: 4 RVA: 0x00012B10 File Offset: 0x00011F10
	internal unsafe static void RAII.CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>.Forget(CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>* A_0)
	{
		*(A_0 + 4) = 0;
	}

	// Token: 0x06000005 RID: 5 RVA: 0x00012AE8 File Offset: 0x00011EE8
	internal unsafe static ushort* RAII.CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>.Steal(CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>* A_0)
	{
		ushort* ptr = *(A_0 + 4);
		*(A_0 + 4) = 0;
		return ptr;
	...
	internal unsafe static bool RAII.CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>.!(CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>* A_0)
	{
		ushort* ptr = 0;
		return calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, ref ptr, (IntPtr)(*(*A_0 + 28)));
	}

	// Token: 0x06000007 RID: 7 RVA: 0x00012A88 File Offset: 0x00011E88
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>.!=(CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>* A_0, ushort** p)
	{
		return (calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, p, (IntPtr)(*(*A_0 + 28))) == 0) ? 1 : 0;
	}
	...
	internal unsafe static ushort* RAII.CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>..QBG(CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x0600000A RID: 10 RVA: 0x000129E8 File Offset: 0x00011DE8
	internal unsafe static ushort* RAII.CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>..PBG(CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x0600000B RID: 11 RVA: 0x000129A0 File Offset: 0x00011DA0
	internal unsafe static ushort* RAII.CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>.->(CAutoCleanupBase<unsigned\u0020short\u0020const\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static void RAII.CAutoComFree<unsigned\u0020short\u0020const\u0020*>.=(CAutoComFree<unsigned\u0020short\u0020const\u0020*>* A_0, ushort* p)
	{
		calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), A_0, (IntPtr)(*(*A_0 + 48)));
		*(A_0 + 4) = p;
	}

	// Token: 0x06000010 RID: 16 RVA: 0x00012784 File Offset: 0x00011B84
	internal unsafe static void RAII.CAutoComFree<unsigned\u0020short\u0020const\u0020*>.Release(CAutoComFree<unsigned\u0020short\u0020const\u0020*>* A_0)
	{
		uint num = (uint)(*(A_0 + 4));
		if (num != 0U)
		{
	...
	internal unsafe static void RAII.CAutoComFree<unsigned\u0020short\u0020const\u0020*>.{dtor}(CAutoComFree<unsigned\u0020short\u0020const\u0020*>* A_0)
	{
	...
	internal unsafe static void* RAII.CAutoComFree<unsigned\u0020short\u0020const\u0020*>.__vecDelDtor(CAutoComFree<unsigned\u0020short\u0020const\u0020*>* A_0, uint A_0)
	{
		if ((A_0 & 2U) != 0U)
		{
	...
	internal unsafe static CDeviceNotificationCallbackShim* CDeviceNotificationCallbackShim.{ctor}(CDeviceNotificationCallbackShim* A_0, DeviceNotificationCallback Callback)
	{
	...
	internal unsafe static void CDeviceNotificationCallbackShim.Connected(CDeviceNotificationCallbackShim* A_0, ushort* DevicePath)
	{
		IntPtr intPtr = (IntPtr)((void*)DevicePath);
		IntPtr intPtr2 = new IntPtr(*(A_0 + 4));
		((GCHandle)intPtr2).Target.Connected(Marshal.PtrToStringUni(intPtr));
	}

	// Token: 0x06000015 RID: 21 RVA: 0x00012FA0 File Offset: 0x000123A0
	internal unsafe static void CDeviceNotificationCallbackShim.Disconnected(CDeviceNotificationCallbackShim* A_0, ushort* DevicePath)
	{
		IntPtr intPtr = (IntPtr)((void*)DevicePath);
		IntPtr intPtr2 = new IntPtr(*(A_0 + 4));
		((GCHandle)intPtr2).Target.Disconnected(Marshal.PtrToStringUni(intPtr));
	}

	// Token: 0x06000016 RID: 22 RVA: 0x00012FE8 File Offset: 0x000123E8
	internal unsafe static void CGenericProgressShim.RegisterProgress(CGenericProgressShim* A_0, uint Progress)
	{
		IntPtr intPtr = new IntPtr(*(A_0 + 4));
		((GCHandle)intPtr).Target.RegisterProgress(Progress);
	}

	// Token: 0x06000017 RID: 23 RVA: 0x00015C78 File Offset: 0x00015078
	internal unsafe static void RAII.CAutoCleanupBase<CGenericProgressShim\u0020*>.Forget(CAutoCleanupBase<CGenericProgressShim\u0020*>* A_0)
	{
		*(A_0 + 4) = 0;
	}

	// Token: 0x06000018 RID: 24 RVA: 0x00014944 File Offset: 0x00013D44
	internal unsafe static CGenericProgressShim* RAII.CAutoCleanupBase<CGenericProgressShim\u0020*>.Steal(CAutoCleanupBase<CGenericProgressShim\u0020*>* A_0)
	{
		CGenericProgressShim* ptr = *(A_0 + 4);
		*(A_0 + 4) = 0;
		return ptr;
	}
	...
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<CGenericProgressShim\u0020*>.!(CAutoCleanupBase<CGenericProgressShim\u0020*>* A_0)
	{
		CGenericProgressShim* ptr = 0;
		return calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,CGenericProgressShim* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, ref ptr, (IntPtr)(*(*A_0 + 28)));
	}

	// Token: 0x0600001A RID: 26 RVA: 0x00014DF0 File Offset: 0x000141F0
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<CGenericProgressShim\u0020*>.!=(CAutoCleanupBase<CGenericProgressShim\u0020*>* A_0, CGenericProgressShim** p)
	{
		return (calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,CGenericProgressShim* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, p, (IntPtr)(*(*A_0 + 28))) == 0) ? 1 : 0;
	}
	...
	internal unsafe static CGenericProgressShim* RAII.CAutoCleanupBase<CGenericProgressShim\u0020*>..QAVCGenericProgressShim@@(CAutoCleanupBase<CGenericProgressShim\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x0600001D RID: 29 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static CGenericProgressShim* RAII.CAutoCleanupBase<CGenericProgressShim\u0020*>..PAVCGenericProgressShim@@(CAutoCleanupBase<CGenericProgressShim\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x0600001E RID: 30 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static CGenericProgressShim* RAII.CAutoCleanupBase<CGenericProgressShim\u0020*>.->(CAutoCleanupBase<CGenericProgressShim\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static void RAII.CAutoDelete<CGenericProgressShim\u0020*>.=(CAutoDelete<CGenericProgressShim\u0020*>* A_0, CGenericProgressShim* p)
	{
		calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), A_0, (IntPtr)(*(*A_0 + 48)));
		*(A_0 + 4) = p;
	}
	...
	internal unsafe static void RAII.CAutoDelete<CGenericProgressShim\u0020*>.Release(CAutoDelete<CGenericProgressShim\u0020*>* A_0)
	{
		uint num = (uint)(*(A_0 + 4));
		if (num != 0U)
		{
	...
	internal unsafe static void RAII.CAutoDelete<CGenericProgressShim\u0020*>.{dtor}(CAutoDelete<CGenericProgressShim\u0020*>* A_0)
	{
	...
	internal unsafe static void RAII.CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>.Forget(CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>* A_0)
	{
		*(A_0 + 4) = 0;
	}

	// Token: 0x06000026 RID: 38 RVA: 0x000147D8 File Offset: 0x00013BD8
	internal unsafe static IFlashingDevice* RAII.CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>.Steal(CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>* A_0)
	{
		IFlashingDevice* ptr = *(A_0 + 4);
		*(A_0 + 4) = 0;
		return ptr;
	}
	...
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>.!(CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>* A_0)
	{
		IFlashingDevice* ptr = 0;
		return calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.IFlashingDevice* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, ref ptr, (IntPtr)(*(*A_0 + 28)));
	}

	// Token: 0x06000028 RID: 40 RVA: 0x00014778 File Offset: 0x00013B78
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>.!=(CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>* A_0, IFlashingDevice** p)
	{
		return (calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.IFlashingDevice* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, p, (IntPtr)(*(*A_0 + 28))) == 0) ? 1 : 0;
	}
	...
	internal unsafe static IFlashingDevice* RAII.CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>..QAUIFlashingDevice@FlashingPlatform@@(CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x0600002B RID: 43 RVA: 0x000146D8 File Offset: 0x00013AD8
	internal unsafe static IFlashingDevice* RAII.CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>..PAUIFlashingDevice@FlashingPlatform@@(CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x0600002C RID: 44 RVA: 0x00014690 File Offset: 0x00013A90
	internal unsafe static IFlashingDevice* RAII.CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>.->(CAutoCleanupBase<FlashingPlatform::IFlashingDevice\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IFlashingDevice\u0020*>.=(CAutoRelease<FlashingPlatform::IFlashingDevice\u0020*>* A_0, IFlashingDevice* p)
	{
		calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), A_0, (IntPtr)(*(*A_0 + 48)));
		*(A_0 + 4) = p;
	}
	...
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IFlashingDevice\u0020*>.Release(CAutoRelease<FlashingPlatform::IFlashingDevice\u0020*>* A_0)
	{
		uint num = (uint)(*(A_0 + 4));
		if (num != 0U)
		{
			uint num2 = num;
			int num3 = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), (IntPtr)num2, (IntPtr)(*(*num2 + 20)));
			*(A_0 + 4) = 0;
		}
	}

	// Token: 0x06000032 RID: 50 RVA: 0x00012DE4 File Offset: 0x000121E4
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IFlashingDevice\u0020*>.{dtor}(CAutoRelease<FlashingPlatform::IFlashingDevice\u0020*>* A_0)
	{
	...
	internal unsafe static void RAII.CAutoCleanupBase<unsigned\u0020char\u0020*>.Forget(CAutoCleanupBase<unsigned\u0020char\u0020*>* A_0)
	{
		*(A_0 + 4) = 0;
	}

	// Token: 0x06000034 RID: 52 RVA: 0x00014944 File Offset: 0x00013D44
	internal unsafe static byte* RAII.CAutoCleanupBase<unsigned\u0020char\u0020*>.Steal(CAutoCleanupBase<unsigned\u0020char\u0020*>* A_0)
	{
		byte* ptr = *(A_0 + 4);
		*(A_0 + 4) = 0;
		return ptr;
	...
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<unsigned\u0020char\u0020*>.!(CAutoCleanupBase<unsigned\u0020char\u0020*>* A_0)
	{
		byte* ptr = 0;
		return calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.Byte* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, ref ptr, (IntPtr)(*(*A_0 + 28)));
	}

	// Token: 0x06000036 RID: 54 RVA: 0x000148E4 File Offset: 0x00013CE4
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<unsigned\u0020char\u0020*>.!=(CAutoCleanupBase<unsigned\u0020char\u0020*>* A_0, byte** p)
	{
		return (calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.Byte* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, p, (IntPtr)(*(*A_0 + 28))) == 0) ? 1 : 0;
	}
	...
	internal unsafe static byte* RAII.CAutoCleanupBase<unsigned\u0020char\u0020*>..QAE(CAutoCleanupBase<unsigned\u0020char\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x06000039 RID: 57 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static byte* RAII.CAutoCleanupBase<unsigned\u0020char\u0020*>..PAE(CAutoCleanupBase<unsigned\u0020char\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x0600003A RID: 58 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static byte* RAII.CAutoCleanupBase<unsigned\u0020char\u0020*>.->(CAutoCleanupBase<unsigned\u0020char\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static void RAII.CAutoDeleteArray<unsigned\u0020char>.=(CAutoDeleteArray<unsigned\u0020char>* A_0, byte* p)
	{
		calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), A_0, (IntPtr)(*(*A_0 + 48)));
		*(A_0 + 4) = p;
	}
	...
	internal unsafe static void RAII.CAutoDeleteArray<unsigned\u0020char>.Release(CAutoDeleteArray<unsigned\u0020char>* A_0)
	{
		uint num = (uint)(*(A_0 + 4));
		if (num != 0U)
		{
	...
	internal unsafe static byte* RAII.CAutoDeleteArray<unsigned\u0020char>.P(CAutoDeleteArray<unsigned\u0020char>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static byte* RAII.CAutoDeleteArray<unsigned\u0020char>.[](CAutoDeleteArray<unsigned\u0020char>* A_0, uint i)
	{
		return *(A_0 + 4) + (int)i;
	}
	...
	internal unsafe static void RAII.CAutoDeleteArray<unsigned\u0020char>.{dtor}(CAutoDeleteArray<unsigned\u0020char>* A_0)
	{
	...
	internal unsafe static void RAII.CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>.=(CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>* A_0, ushort* p)
	{
		calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), A_0, (IntPtr)(*(*A_0 + 48)));
		*(A_0 + 4) = p;
	}
	...
	internal unsafe static void RAII.CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>.Release(CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>* A_0)
	{
		uint num = (uint)(*(A_0 + 4));
		if (num != 0U)
		{
	...
	internal unsafe static ushort* RAII.CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>.P(CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static ushort* RAII.CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>.[](CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>* A_0, uint i)
	{
	...
	internal unsafe static void RAII.CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>.{dtor}(CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>* A_0)
	{
	...
	internal unsafe static void RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>.Forget(CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>* A_0)
	{
		*(A_0 + 4) = 0;
	}

	// Token: 0x0600004D RID: 77 RVA: 0x00014CC8 File Offset: 0x000140C8
	internal unsafe static IConnectedDevice* RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>.Steal(CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>* A_0)
	{
		IConnectedDevice* ptr = *(A_0 + 4);
		*(A_0 + 4) = 0;
		return ptr;
	}
	...
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>.!(CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>* A_0)
	{
		IConnectedDevice* ptr = 0;
		return calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.IConnectedDevice* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, ref ptr, (IntPtr)(*(*A_0 + 28)));
	}

	// Token: 0x0600004F RID: 79 RVA: 0x00014C68 File Offset: 0x00014068
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>.!=(CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>* A_0, IConnectedDevice** p)
	{
		return (calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.IConnectedDevice* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, p, (IntPtr)(*(*A_0 + 28))) == 0) ? 1 : 0;
	}
	...
	internal unsafe static IConnectedDevice* RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>..QAUIConnectedDevice@FlashingPlatform@@(CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x06000052 RID: 82 RVA: 0x00014BC8 File Offset: 0x00013FC8
	internal unsafe static IConnectedDevice* RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>..PAUIConnectedDevice@FlashingPlatform@@(CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x06000053 RID: 83 RVA: 0x00014B80 File Offset: 0x00013F80
	internal unsafe static IConnectedDevice* RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>.->(CAutoCleanupBase<FlashingPlatform::IConnectedDevice\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IConnectedDevice\u0020*>.=(CAutoRelease<FlashingPlatform::IConnectedDevice\u0020*>* A_0, IConnectedDevice* p)
	{
		calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), A_0, (IntPtr)(*(*A_0 + 48)));
		*(A_0 + 4) = p;
	}
	...
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IConnectedDevice\u0020*>.Release(CAutoRelease<FlashingPlatform::IConnectedDevice\u0020*>* A_0)
	{
		uint num = (uint)(*(A_0 + 4));
		if (num != 0U)
		{
	...
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IConnectedDevice\u0020*>.{dtor}(CAutoRelease<FlashingPlatform::IConnectedDevice\u0020*>* A_0)
	{
	...
	internal unsafe static void gcroot<Microsoft::Windows::Flashing::Platform::GenericProgress\u0020^>.{dtor}(gcroot<Microsoft::Windows::Flashing::Platform::GenericProgress\u0020^>* A_0)
	{
	...
	internal unsafe static void gcroot<Microsoft::Windows::Flashing::Platform::DeviceNotificationCallback\u0020^>.{dtor}(gcroot<Microsoft::Windows::Flashing::Platform::DeviceNotificationCallback\u0020^>* A_0)
	{
		IntPtr intPtr = new IntPtr(*A_0);
		((GCHandle)intPtr).Free();
		*A_0 = 0;
	...
	internal unsafe static void* RAII.CAutoDelete<CGenericProgressShim\u0020*>.__vecDelDtor(CAutoDelete<CGenericProgressShim\u0020*>* A_0, uint A_0)
	{
		if ((A_0 & 2U) != 0U)
		{
	...
	internal unsafe static void* RAII.CAutoRelease<FlashingPlatform::IFlashingDevice\u0020*>.__vecDelDtor(CAutoRelease<FlashingPlatform::IFlashingDevice\u0020*>* A_0, uint A_0)
	{
		if ((A_0 & 2U) != 0U)
		{
	...
	internal unsafe static void* RAII.CAutoDeleteArray<unsigned\u0020char>.__vecDelDtor(CAutoDeleteArray<unsigned\u0020char>* A_0, uint A_0)
	{
		if ((A_0 & 2U) != 0U)
		{
	...
	internal unsafe static void* RAII.CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>.__vecDelDtor(CAutoDeleteArray<unsigned\u0020short\u0020const\u0020>* A_0, uint A_0)
	{
		if ((A_0 & 2U) != 0U)
		{
	...
	internal unsafe static void* RAII.CAutoRelease<FlashingPlatform::IConnectedDevice\u0020*>.__vecDelDtor(CAutoRelease<FlashingPlatform::IConnectedDevice\u0020*>* A_0, uint A_0)
	{
		if ((A_0 & 2U) != 0U)
		{
	...
	internal unsafe static void RAII.CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>.Forget(CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>* A_0)
	{
		*(A_0 + 4) = 0;
	}

	// Token: 0x06000062 RID: 98 RVA: 0x00014944 File Offset: 0x00013D44
	internal unsafe static CDeviceNotificationCallbackShim* RAII.CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>.Steal(CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>* A_0)
	{
		CDeviceNotificationCallbackShim* ptr = *(A_0 + 4);
		*(A_0 + 4) = 0;
		return ptr;
	}
	...
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>.!(CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>* A_0)
	{
		CDeviceNotificationCallbackShim* ptr = 0;
		return calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,CDeviceNotificationCallbackShim* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, ref ptr, (IntPtr)(*(*A_0 + 28)));
	}

	// Token: 0x06000064 RID: 100 RVA: 0x00015E78 File Offset: 0x00015278
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>.!=(CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>* A_0, CDeviceNotificationCallbackShim** p)
	{
		return (calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,CDeviceNotificationCallbackShim* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, p, (IntPtr)(*(*A_0 + 28))) == 0) ? 1 : 0;
	}
	...
	internal unsafe static CDeviceNotificationCallbackShim* RAII.CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>..QAVCDeviceNotificationCallbackShim@@(CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x06000067 RID: 103 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static CDeviceNotificationCallbackShim* RAII.CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>..PAVCDeviceNotificationCallbackShim@@(CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x06000068 RID: 104 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static CDeviceNotificationCallbackShim* RAII.CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>.->(CAutoCleanupBase<CDeviceNotificationCallbackShim\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static void RAII.CAutoDelete<CDeviceNotificationCallbackShim\u0020*>.=(CAutoDelete<CDeviceNotificationCallbackShim\u0020*>* A_0, CDeviceNotificationCallbackShim* p)
	{
		calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), A_0, (IntPtr)(*(*A_0 + 48)));
		*(A_0 + 4) = p;
	}
	...
	internal unsafe static void RAII.CAutoDelete<CDeviceNotificationCallbackShim\u0020*>.Release(CAutoDelete<CDeviceNotificationCallbackShim\u0020*>* A_0)
	{
		uint num = (uint)(*(A_0 + 4));
		if (num != 0U)
		{
	...
	internal unsafe static void RAII.CAutoDelete<CDeviceNotificationCallbackShim\u0020*>.{dtor}(CAutoDelete<CDeviceNotificationCallbackShim\u0020*>* A_0)
	{
	...
	internal unsafe static void RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>.Forget(CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0)
	{
		*(A_0 + 4) = 0;
	}

	// Token: 0x06000070 RID: 112 RVA: 0x00014944 File Offset: 0x00013D44
	internal unsafe static IConnectedDeviceCollection* RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>.Steal(CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0)
	{
		IConnectedDeviceCollection* ptr = *(A_0 + 4);
		*(A_0 + 4) = 0;
		return ptr;
	}
	...
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>.!(CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0)
	{
		IConnectedDeviceCollection* ptr = 0;
		return calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.IConnectedDeviceCollection* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, ref ptr, (IntPtr)(*(*A_0 + 28)));
	}

	// Token: 0x06000072 RID: 114 RVA: 0x00015C10 File Offset: 0x00015010
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>.!=(CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0, IConnectedDeviceCollection** p)
	{
		return (calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.IConnectedDeviceCollection* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, p, (IntPtr)(*(*A_0 + 28))) == 0) ? 1 : 0;
	}
	...
	internal unsafe static IConnectedDeviceCollection* RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>..QAUIConnectedDeviceCollection@FlashingPlatform@@(CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x06000075 RID: 117 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static IConnectedDeviceCollection* RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>..PAUIConnectedDeviceCollection@FlashingPlatform@@(CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x06000076 RID: 118 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static IConnectedDeviceCollection* RAII.CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>.->(CAutoCleanupBase<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IConnectedDeviceCollection\u0020*>.=(CAutoRelease<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0, IConnectedDeviceCollection* p)
	{
		calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), A_0, (IntPtr)(*(*A_0 + 48)));
		*(A_0 + 4) = p;
	}
	...
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IConnectedDeviceCollection\u0020*>.Release(CAutoRelease<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0)
	{
		uint num = (uint)(*(A_0 + 4));
		if (num != 0U)
		{
			uint num2 = num;
			int num3 = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), (IntPtr)num2, (IntPtr)(*(*num2 + 8)));
			*(A_0 + 4) = 0;
		}
	}

	// Token: 0x0600007C RID: 124 RVA: 0x00014FD8 File Offset: 0x000143D8
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IConnectedDeviceCollection\u0020*>.{dtor}(CAutoRelease<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0)
	{
	...
	internal unsafe static void RAII.CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>.Forget(CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>* A_0)
	{
		*(A_0 + 4) = 0;
	}

	// Token: 0x0600007E RID: 126 RVA: 0x00014944 File Offset: 0x00013D44
	internal unsafe static IFlashingPlatform* RAII.CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>.Steal(CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>* A_0)
	{
		IFlashingPlatform* ptr = *(A_0 + 4);
		*(A_0 + 4) = 0;
		return ptr;
	}
	...
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>.!(CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>* A_0)
	{
		IFlashingPlatform* ptr = 0;
		return calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.IFlashingPlatform* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, ref ptr, (IntPtr)(*(*A_0 + 28)));
	}

	// Token: 0x06000080 RID: 128 RVA: 0x00015D5C File Offset: 0x0001515C
	[return: MarshalAs(UnmanagedType.U1)]
	internal unsafe static bool RAII.CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>.!=(CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>* A_0, IFlashingPlatform** p)
	{
		return (calli(System.Byte modopt(System.Runtime.CompilerServices.CompilerMarshalOverride) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.IFlashingPlatform* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.IsImplicitlyDereferenced)), A_0, p, (IntPtr)(*(*A_0 + 28))) == 0) ? 1 : 0;
	}
	...
	internal unsafe static IFlashingPlatform* RAII.CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>..QAUIFlashingPlatform@FlashingPlatform@@(CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x06000083 RID: 131 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static IFlashingPlatform* RAII.CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>..PAUIFlashingPlatform@FlashingPlatform@@(CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}

	// Token: 0x06000084 RID: 132 RVA: 0x00014D9C File Offset: 0x0001419C
	internal unsafe static IFlashingPlatform* RAII.CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>.->(CAutoCleanupBase<FlashingPlatform::IFlashingPlatform\u0020*>* A_0)
	{
		return *(A_0 + 4);
	}
	...
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IFlashingPlatform\u0020*>.=(CAutoRelease<FlashingPlatform::IFlashingPlatform\u0020*>* A_0, IFlashingPlatform* p)
	{
		calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), A_0, (IntPtr)(*(*A_0 + 48)));
		*(A_0 + 4) = p;
	}
	...
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IFlashingPlatform\u0020*>.Release(CAutoRelease<FlashingPlatform::IFlashingPlatform\u0020*>* A_0)
	{
		uint num = (uint)(*(A_0 + 4));
		if (num != 0U)
		{
			uint num2 = num;
			int num3 = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), (IntPtr)num2, (IntPtr)(*(*num2 + 28)));
			*(A_0 + 4) = 0;
		}
	}

	// Token: 0x0600008A RID: 138 RVA: 0x00015024 File Offset: 0x00014424
	internal unsafe static void RAII.CAutoRelease<FlashingPlatform::IFlashingPlatform\u0020*>.{dtor}(CAutoRelease<FlashingPlatform::IFlashingPlatform\u0020*>* A_0)
	{
	...
	internal unsafe static void* RAII.CAutoDelete<CDeviceNotificationCallbackShim\u0020*>.__vecDelDtor(CAutoDelete<CDeviceNotificationCallbackShim\u0020*>* A_0, uint A_0)
	{
		if ((A_0 & 2U) != 0U)
		{
	...
	internal unsafe static void* RAII.CAutoRelease<FlashingPlatform::IConnectedDeviceCollection\u0020*>.__vecDelDtor(CAutoRelease<FlashingPlatform::IConnectedDeviceCollection\u0020*>* A_0, uint A_0)
	{
		if ((A_0 & 2U) != 0U)
		{
	...
	internal unsafe static void* RAII.CAutoRelease<FlashingPlatform::IFlashingPlatform\u0020*>.__vecDelDtor(CAutoRelease<FlashingPlatform::IFlashingPlatform\u0020*>* A_0, uint A_0)
	{
		if ((A_0 & 2U) != 0U)
		{
	...
	internal static void ?A0x2442659e.??__E?Initialized@CurrentDomain@<CrtImplementationDetails>@@$$Q2HA@@YMXXZ()
	{
	...
	internal static void ?A0x2442659e.??__E?Uninitialized@CurrentDomain@<CrtImplementationDetails>@@$$Q2HA@@YMXXZ()
	{
	...
	internal static void ?A0x2442659e.??__E?IsDefaultDomain@CurrentDomain@<CrtImplementationDetails>@@$$Q2_NA@@YMXXZ()
	{
	...
	internal static void ?A0x2442659e.??__E?InitializedVtables@CurrentDomain@<CrtImplementationDetails>@@$$Q2W4State@Progress@2@A@@YMXXZ()
	{
	...
	internal static void ?A0x2442659e.??__E?InitializedNative@CurrentDomain@<CrtImplementationDetails>@@$$Q2W4State@Progress@2@A@@YMXXZ()
	{
	...
	internal static void ?A0x2442659e.??__E?InitializedPerProcess@CurrentDomain@<CrtImplementationDetails>@@$$Q2W4State@Progress@2@A@@YMXXZ()
	{
	...
	internal static void ?A0x2442659e.??__E?InitializedPerAppDomain@CurrentDomain@<CrtImplementationDetails>@@$$Q2W4State@Progress@2@A@@YMXXZ()
	{
	...
	{
		string text = "The C++ module failed to load during vtable initialization.\n";
		IntPtr intPtr = new IntPtr(*A_0);
		((GCHandle)intPtr).Target = text;
	...
	{
		string text = "The C++ module failed to load while attempting to initialize the default appdomain.\n";
		IntPtr intPtr = new IntPtr(*A_0);
		((GCHandle)intPtr).Target = text;
	...
	{
		string text = "The C++ module failed to load during native initialization.\n";
		IntPtr intPtr = new IntPtr(*A_0);
		((GCHandle)intPtr).Target = text;
		...
		else if (<Module>.__native_startup_state == (__enative_startup_state)0)
		{
			...
			{
				IntPtr intPtr2 = new IntPtr(*A_0);
				<Module>.<CrtImplementationDetails>.ThrowModuleLoadException(((GCHandle)intPtr2).Target);
			}
	...
	{
		string text = "The C++ module failed to load during process initialization.\n";
		IntPtr intPtr = new IntPtr(*A_0);
		((GCHandle)intPtr).Target = text;
	...
	{
		string text = "The C++ module failed to load during appdomain initialization.\n";
		IntPtr intPtr = new IntPtr(*A_0);
		((GCHandle)intPtr).Target = text;
	...
	{
		string text = "The C++ module failed to load during registration for the unload events.\n";
		IntPtr intPtr = new IntPtr(*A_0);
		((GCHandle)intPtr).Target = text;
	...
	internal unsafe static void <CrtImplementationDetails>.LanguageSupport._Initialize(LanguageSupport* A_0)
	{
		...
		try
		{
			while (num2 == 0)
			{
				...
				finally
				{
					...
					IntPtr intPtr3 = Interlocked.CompareExchange(ref <Module>.__native_startup_lock, intPtr2, intPtr);
		...
		finally
		{
			if (num == 0)
			{
				...
				Interlocked.Exchange(ref <Module>.__native_startup_lock, intPtr4);
			}
		}
		if (num3 != 0)
		{
	...
	internal unsafe static void <CrtImplementationDetails>.LanguageSupport.Initialize(LanguageSupport* A_0)
	{
		...
		catch (Exception ex)
		{
			...
			IntPtr intPtr = new IntPtr(*A_0);
			<Module>.<CrtImplementationDetails>.ThrowModuleLoadException(((GCHandle)intPtr).Target, ex);
		}
		catch (object obj)
		{
			<Module>.<CrtImplementationDetails>.LanguageSupport.Cleanup(A_0, null);
			IntPtr intPtr2 = new IntPtr(*A_0);
			<Module>.<CrtImplementationDetails>.ThrowModuleLoadException(((GCHandle)intPtr2).Target, null);
		}
	}
				...
				for (;;)
				{
					...
					if (*(int*)ptr2 != <Module>._encoded_null())
					{
						...
						*(int*)ptr2 = <Module>._encoded_null();
						...
						method* ptr5 = <Module>._decode_pointer((void*)<Module>.?A0x103fe9b9.__onexitbegin_m);
						method* ptr6 = <Module>._decode_pointer((void*)<Module>.?A0x103fe9b9.__onexitend_m);
	...
	internal unsafe static bad_alloc* std.bad_alloc.{ctor}(bad_alloc* A_0)
	{
	...
	internal static void ?A0xba0a35f5.??__Fnomem@?6???_U@YAPAXI@Z@YMXXZ()
	{
	...
	[PrePrepareMethod]
	[SecurityPermission(SecurityAction.Assert, UnmanagedCode = true)]
	internal unsafe static int ?A0x47ab7201.GetDllBaseAndSizeFromAddress(void* Address, void** OutBase, uint* OutSize)
	{
	...
	[PrePrepareMethod]
	internal unsafe static int ?A0x47ab7201.IsPointerInMsvcrtDll(void* p, int* Result)
	{
		int num = 0;
		if (Result != null)
		{
		...
		if (p != null && Result != null)
		{
			...
			{
				uint num2;
				if (<Module>.?A0x47ab7201.GetDllBaseAndSizeFromAddress((void*)<Module>.__unep@?_errno@@$$J0YAPAHXZ, &<Module>.?A0x47ab7201.?Begin@?1??IsPointerInMsvcrtDll@?A0x47ab7201@@YAHPAXPAH@Z@4PAXA, &num2) == null)
				{
					return num;
				}
				<Module>.?A0x47ab7201.?End@?1??IsPointerInMsvcrtDll@?A0x47ab7201@@YAHPAXPAH@Z@4PAXA = (void*)((byte*)<Module>.?A0x47ab7201.?Begin@?1??IsPointerInMsvcrtDll@?A0x47ab7201@@YAHPAXPAH@Z@4PAXA + num2);
			}
			int num3;
	...
	internal unsafe static _tiddata_managed* _getptd_noexit()
	{
		...
		_tiddata_managed* ptr = null;
		if ((<Module>.GetVersion() & 255) >= 6)
		{
			int* ptr2 = <Module>._errno();
			int num = 0;
			if (<Module>.?A0x47ab7201.IsPointerInMsvcrtDll(ptr2, &num) != null && num == 0)
			{
				ptr = ptr2 - 8;
			}
		}
	...
	{
		void* ptr = null;
		HINSTANCE__* ptr2 = <Module>.GetModuleHandleA((sbyte*)(&<Module>.??_C@_0P@OEFGOMJK@kernelbase?4dll?$AA@));
		if (ptr2 == null)
		{
			ptr2 = <Module>.GetModuleHandleA((sbyte*)(&<Module>.??_C@_0N@MDJJJHMB@kernel32?4dll?$AA@));
			if (ptr2 == null)
			{
				return ptr;
			}
		}
		ptr = <Module>.GetProcAddress(ptr2, pszFunction);
		return ptr;
	}
	...
	internal unsafe static ushort ?A0xf690dbd3._putwc_nolock([MarshalAs(UnmanagedType.U2)] char _c, _iobuf* _stream)
	{
	...
	internal unsafe static void ?A0xf690dbd3.write_char([MarshalAs(UnmanagedType.U2)] char ch, _iobuf* f, int* pnumwritten)
	{
	...
	internal unsafe static void ?A0xf690dbd3.write_multi_char([MarshalAs(UnmanagedType.U2)] char ch, int num, _iobuf* f, int* pnumwritten)
	{
		if (num > 0)
		{
			do
	...
	internal unsafe static void ?A0xf690dbd3.write_string(char* @string, int len, _iobuf* f, int* pnumwritten)
	{
		if ((*(int*)(f + 12 / sizeof(_iobuf)) & 64) != 0 && *(int*)(f + 8 / sizeof(_iobuf)) == 0)
		{
			*pnumwritten += len;
	...
	internal unsafe static int _safecrt_cfltcvt(_CRT_DOUBLE* arg, sbyte* buffer, uint _SizeInBytes, int type, int precision, int flags)
	{
		...
		*(byte*)(_SizeInBytes / (uint)sizeof(sbyte) + buffer - 1 / sizeof(sbyte)) = 0;
		int num2 = <Module>._snprintf(buffer, _SizeInBytes, (sbyte*)(&$ArrayType$$$BY0BO@D), __arglist(*(double*)arg));
	...
	[MethodImpl(MethodImplOptions.Unmanaged, MethodCodeType = MethodCodeType.Native)]
	internal unsafe static extern exception* exception.{ctor}(exception*, exception*);

	// Token: 0x060000F5 RID: 245 RVA: 0x0001980A File Offset: 0x00018C0A
	[SuppressUnmanagedCodeSecurity]
	[DllImport("", CallingConvention = CallingConvention.ThisCall, SetLastError = true)]
	[MethodImpl(MethodImplOptions.Unmanaged, MethodCodeType = MethodCodeType.Native)]
	internal unsafe static extern exception* exception.{ctor}(exception*);

	// Token: 0x060000F6 RID: 246 RVA: 0x00019816 File Offset: 0x00018C16
	[SuppressUnmanagedCodeSecurity]
	[DllImport("", CallingConvention = CallingConvention.ThisCall, SetLastError = true)]
	[MethodImpl(MethodImplOptions.Unmanaged, MethodCodeType = MethodCodeType.Native)]
	internal unsafe static extern void exception.{dtor}(exception*);
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ATL.?A0xea60aed3._AtlReleaseManagedClassFactories$initializer$;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static sbyte* ATL.?A0xea60aed3.szValToken;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static sbyte* ATL.?A0xea60aed3.szDelete;

	// Token: 0x04000026 RID: 38 RVA: 0x0001AE50 File Offset: 0x00000000
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static sbyte* ATL.?A0xea60aed3.szBinaryVal;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static sbyte* ATL.?A0xea60aed3.szForceRemove;

	// Token: 0x0400002C RID: 44 RVA: 0x00001050 File Offset: 0x00000450
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static sbyte* ATL.?A0xea60aed3.szStringVal;

	// Token: 0x0400002D RID: 45 RVA: 0x00001054 File Offset: 0x00000454
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static sbyte* ATL.?A0xea60aed3.multiszStringVal;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static sbyte* ATL.?A0xea60aed3.szNoRemove;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static sbyte* ATL.?A0xea60aed3.szDwordVal;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ?A0x2442659e.?InitializedPerProcess$initializer$@CurrentDomain@<CrtImplementationDetails>@@$$Q2P6MXXZA;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ?A0x2442659e.?IsDefaultDomain$initializer$@CurrentDomain@<CrtImplementationDetails>@@$$Q2P6MXXZA;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ?A0x2442659e.?Initialized$initializer$@CurrentDomain@<CrtImplementationDetails>@@$$Q2P6MXXZA;

	// Token: 0x040000CC RID: 204 RVA: 0x00001034 File Offset: 0x00000434
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ?A0x2442659e.?InitializedPerAppDomain$initializer$@CurrentDomain@<CrtImplementationDetails>@@$$Q2P6MXXZA;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ?A0x2442659e.?InitializedNative$initializer$@CurrentDomain@<CrtImplementationDetails>@@$$Q2P6MXXZA;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ?A0x2442659e.?InitializedVtables$initializer$@CurrentDomain@<CrtImplementationDetails>@@$$Q2P6MXXZA;

	// Token: 0x040000D1 RID: 209 RVA: 0x00001020 File Offset: 0x00000420
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ?A0x2442659e.?Uninitialized$initializer$@CurrentDomain@<CrtImplementationDetails>@@$$Q2P6MXXZA;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static method* ?A0x103fe9b9.__onexitbegin_m;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static method* ?A0x103fe9b9.__onexitend_m;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static sbyte* std._bad_alloc_Message;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static void* ?A0x47ab7201.?Begin@?1??IsPointerInMsvcrtDll@?A0x47ab7201@@YAHPAXPAH@Z@4PAXA;

	// Token: 0x040000F4 RID: 244 RVA: 0x0001AB10 File Offset: 0x00019B10
	// Note: this field is marked with 'hasfieldrva'.
	internal unsafe static void* ?A0x47ab7201.?End@?1??IsPointerInMsvcrtDll@?A0x47ab7201@@YAHPAXPAH@Z@4PAXA;
	...
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ?A0x00a411d4.?pfnDecodePointer@?1??_decode_pointer@@YAPAXPAX@Z@4P6GPAX0@ZA;

	// Token: 0x040000FD RID: 253 RVA: 0x0001AB18 File Offset: 0x00019B18
	// Note: this field is marked with 'hasfieldrva'.
	internal static method ?A0x00a411d4.?pfnEncodePointer@?1??_encode_pointer@@YAPAXPAX@Z@4P6GPAX0@ZA;
	...
	// Token: 0x04000102 RID: 258 RVA: 0x0001AE60 File Offset: 0x00000000
	// Note: this field is marked with 'hasfieldrva'.
	...
	// Token: 0x04000104 RID: 260 RVA: 0x0001AE8C File Offset: 0x00000000
	// Note: this field is marked with 'hasfieldrva'.
	...
	// Token: 0x04000106 RID: 262 RVA: 0x0001AE88 File Offset: 0x00000000
	// Note: this field is marked with 'hasfieldrva'.
