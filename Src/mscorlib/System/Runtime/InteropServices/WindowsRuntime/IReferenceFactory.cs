...
namespace System.Runtime.InteropServices.WindowsRuntime
{
	...
	{
		// Token: 0x06006567 RID: 25959 RVA: 0x0015A5B8 File Offset: 0x001587B8
		...
		internal static object CreateIReference(object obj)
		{
			...
			{
				Type type2 = typeof(CLRIReferenceImpl<>).MakeGenericType(new Type[] { type });
				return Activator.CreateInstance(type2, new object[] { propertyType.Value, obj });
			}
			return null;
		}

		// Token: 0x06006568 RID: 25960 RVA: 0x0015A8A0 File Offset: 0x00158AA0
		[SecuritySafeCritical]
		internal static object CreateIReferenceArray(Array obj)
		{
			...
			if (propertyType != null)
			{
				Type type = typeof(CLRIReferenceArrayImpl<>).MakeGenericType(new Type[] { elementType });
				return Activator.CreateInstance(type, new object[] { propertyType.Value, obj });
			}
