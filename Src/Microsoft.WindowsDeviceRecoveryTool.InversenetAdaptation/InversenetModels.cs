...
namespace Microsoft.WindowsDeviceRecoveryTool.InversenetAdaptation
{
	...
	internal static class InversenetModels
	{
		...
		private static ModelInfo CreateNeoModelInfo()
		{
			...
			IdentificationInfo identificationInfo = new IdentificationInfo(new string[] { "EveryPhone" });
			...
			return new ModelInfo(Resources.FriendlyName_EveryPhone, Resources.EveryPhone, detectionInfo, new VariantInfo[] { variantInfo });
		}
