...
namespace System.Security.Cryptography
{
	...
	public class SHA384Managed : SHA384
	{
		...
		// Token: 0x06002369 RID: 9065 RVA: 0x00080E1C File Offset: 0x0007F01C
		...
		// Token: 0x0600236A RID: 9066 RVA: 0x00080E90 File Offset: 0x0007F090
		...
		// Token: 0x0600236B RID: 9067 RVA: 0x00080EDF File Offset: 0x0007F0DF
		...
		// Token: 0x0600236C RID: 9068 RVA: 0x00080F04 File Offset: 0x0007F104
		[SecuritySafeCritical]
		...
		// Token: 0x0600236D RID: 9069 RVA: 0x00080F33 File Offset: 0x0007F133
		...
		// Token: 0x0600236E RID: 9070 RVA: 0x00080F54 File Offset: 0x0007F154
		...
		// Token: 0x0600236F RID: 9071 RVA: 0x00080FF4 File Offset: 0x0007F1F4
		[SecurityCritical]
		...
		// Token: 0x06002370 RID: 9072 RVA: 0x0008111C File Offset: 0x0007F31C
		[SecurityCritical]
		...
		// Token: 0x06002371 RID: 9073 RVA: 0x00081210 File Offset: 0x0007F410
		[SecurityCritical]
		...
		// Token: 0x06002372 RID: 9074 RVA: 0x0008152D File Offset: 0x0007F72D
		private static ulong RotateRight(ulong x, int n)
		{
			return (x >> n) | (x << 64 - n);
		}

		// Token: 0x06002373 RID: 9075 RVA: 0x0008153F File Offset: 0x0007F73F
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x06002374 RID: 9076 RVA: 0x0008154B File Offset: 0x0007F74B
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x06002375 RID: 9077 RVA: 0x00081558 File Offset: 0x0007F758
		private static ulong Sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 28) ^ SHA384Managed.RotateRight(x, 34) ^ SHA384Managed.RotateRight(x, 39);
		}

		// Token: 0x06002376 RID: 9078 RVA: 0x00081574 File Offset: 0x0007F774
		private static ulong Sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 14) ^ SHA384Managed.RotateRight(x, 18) ^ SHA384Managed.RotateRight(x, 41);
		}

		// Token: 0x06002377 RID: 9079 RVA: 0x00081590 File Offset: 0x0007F790
		private static ulong sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 1) ^ SHA384Managed.RotateRight(x, 8) ^ (x >> 7);
		}

		// Token: 0x06002378 RID: 9080 RVA: 0x000815A5 File Offset: 0x0007F7A5
		private static ulong sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 19) ^ SHA384Managed.RotateRight(x, 61) ^ (x >> 6);
		}

		// Token: 0x06002379 RID: 9081 RVA: 0x000815BC File Offset: 0x0007F7BC
		[SecurityCritical]
