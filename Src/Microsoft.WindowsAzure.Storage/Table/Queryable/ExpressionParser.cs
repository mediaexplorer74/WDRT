...
namespace Microsoft.WindowsAzure.Storage.Table.Queryable
{
	...
	internal class ExpressionParser : DataServiceALinqExpressionVisitor
	{
		...
		{
			throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, "The method '{0}' is not supported.", new object[] { m.Method.Name }));
		}

		// Token: 0x06001306 RID: 4870 RVA: 0x000474C4 File Offset: 0x000456C4
		internal override Expression VisitUnary(UnaryExpression u)
		{
			throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, "The unary operator '{0}' is not supported.", new object[] { u.NodeType.ToString() }));
		}

		// Token: 0x06001307 RID: 4871 RVA: 0x00047500 File Offset: 0x00045700
		internal override Expression VisitBinary(BinaryExpression b)
		{
			throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, "The binary operator '{0}' is not supported.", new object[] { b.NodeType.ToString() }));
		}

		// Token: 0x06001308 RID: 4872 RVA: 0x0004753C File Offset: 0x0004573C
		internal override Expression VisitConstant(ConstantExpression c)
		{
			throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, "The constant for '{0}' is not supported.", new object[] { c.Value }));
		}
		...
		{
			throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, "The member access of '{0}' is not supported.", new object[] { m.Member.Name }));
		}
