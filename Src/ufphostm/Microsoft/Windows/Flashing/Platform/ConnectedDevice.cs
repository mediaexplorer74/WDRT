...
namespace Microsoft.Windows.Flashing.Platform
{
	...
	public class ConnectedDevice : IDisposable
	{
        ...
        internal unsafe ConnectedDevice(IConnectedDevice* Device, [In] FlashingPlatform Platform) : base()
		{
		...
		private unsafe void UnConnectedDevice1()
		{
			...
			if (device != null)
			{
				if (this.m_OwnDevice)
				{
					...
					object obj = null;//calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ptr, *(*(int*)ptr + 20));
				}
				this.m_Device = null;
			}
		}
		...
		public unsafe virtual string GetDevicePath()
		{
			IConnectedDevice* device = this.m_Device;
			ushort* value;
			int num = -1;//calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)**), device, ref value, *(*(int*)device));
			if (num < 0)
			{
		...
		public unsafe virtual void SendRawData([In] byte[] Message, uint MessageLength, uint Timeout)
		{
			...
			try
			{
				IntPtr destination = default;//(IntPtr)calli(System.Byte* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDeleteArray<unsigned_u0020char>, *(cautoDeleteArray<unsigned_u0020char> + 16));
				Marshal.Copy(Message, 0, destination, (int)MessageLength);
				IConnectedDevice* device = this.m_Device;
				int num = -1;//calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.Byte* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst),System.UInt32 modopt(System.Runtime.CompilerServices.IsLong),System.UInt32 modopt(System.Runtime.CompilerServices.IsLong)), device, calli(System.Byte* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDeleteArray<unsigned_u0020char>, *(cautoDeleteArray<unsigned_u0020char> + 16)), MessageLength, Timeout, *(*(int*)device + 4));
				if (num < 0)
				{
		...
		public unsafe virtual void ReceiveRawData(out byte[] Message, ref uint MessageLength, uint Timeout)
		{
			...
			{
				IConnectedDevice* device = this.m_Device;
				int num2 = -1;//calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.Byte* modopt(System.Runtime.CompilerServices.IsConst) modopt(System.Runtime.CompilerServices.IsConst),System.UInt32 modopt(System.Runtime.CompilerServices.IsLong)*,System.UInt32 modopt(System.Runtime.CompilerServices.IsLong)), device, calli(System.Byte* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDeleteArray<unsigned_u0020char>, *(cautoDeleteArray<unsigned_u0020char> + 16)), ref num, Timeout, *(*(int*)device + 8));
				MessageLength = num;
				if (num2 < 0)
				{
					...
					try
					{
						...
						{
							IFlashingPlatform* native2 = this.m_Platform.Native;
							int num3 = -1;//calli(FlashingPlatform.ILogger* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), native2, *(*(int*)native2));
		...
		{
			IConnectedDevice* device = this.m_Device;
			return false;//((calli(System.Int32 modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), device, *(*(int*)device + 12)) != 0) ? 1 : 0) != 0;
		}
		...
		public unsafe virtual FlashingDevice CreateFlashingDevice()
		{
			...
			try
			{
				...
				result = default;//new FlashingDevice(calli(FlashingPlatform.IFlashingDevice* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoRelease<FlashingPlatform::IFlashingDevice_u0020*>, *(cautoRelease<FlashingPlatform::IFlashingDevice_u0020*> + 40)), this.m_Platform);
			}
			catch
			{
