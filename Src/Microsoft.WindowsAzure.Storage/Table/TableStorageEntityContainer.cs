...
namespace Microsoft.WindowsAzure.Storage.Table
{
	...
	internal class TableStorageEntityContainer : EdmEntityContainer
	{
		...
		public override IEdmEntitySet FindEntitySet(string setName)
		{
			...
			{
				string text = this.InferServerTypeNameFromTableName(setName);
				edmEntitySet = new EdmEntitySet(this, setName, (IEdmEntityType)((IEdmModel)this.model).FindDeclaredType(text));
