...
namespace Microsoft.Diagnostics.Tracing
{
	...
	public class EventSourceException : Exception
	{
		...
		public EventSourceException()
			: base(Microsoft.Diagnostics.Tracing.Internal.Environment.GetResourceString("EventSource_ListenerWriteFailure", new object[0]))
		{
		}
		...
		internal EventSourceException(Exception innerException)
			: base(Microsoft.Diagnostics.Tracing.Internal.Environment.GetResourceString("EventSource_ListenerWriteFailure", new object[0]), innerException)
		{
		}
	}
}
