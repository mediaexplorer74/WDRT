...
namespace System.Management
{
	...
	{
		// Token: 0x06000290 RID: 656 RVA: 0x0000DC46 File Offset: 0x0000BE46
		...
		// Token: 0x06000291 RID: 657 RVA: 0x0000DC6C File Offset: 0x0000BE6C
		...
		// (get) Token: 0x06000292 RID: 658 RVA: 0x0000DCD6 File Offset: 0x0000BED6
		public string Name
		{
			get
			{
		...
		// (get) Token: 0x06000293 RID: 659 RVA: 0x0000DCEC File Offset: 0x0000BEEC
		// (set) Token: 0x06000294 RID: 660 RVA: 0x0000DD20 File Offset: 0x0000BF20
		public object Value
		{
			get
			{
		...
		// (get) Token: 0x06000295 RID: 661 RVA: 0x0000DDE3 File Offset: 0x0000BFE3
		public CimType Type
		{
			get
			{
		...
		// (get) Token: 0x06000296 RID: 662 RVA: 0x0000DDF7 File Offset: 0x0000BFF7
		public bool IsLocal
		{
			get
			{
		...
		// (get) Token: 0x06000297 RID: 663 RVA: 0x0000DE0D File Offset: 0x0000C00D
		public bool IsArray
		{
			get
			{
		...
		// (get) Token: 0x06000298 RID: 664 RVA: 0x0000DE24 File Offset: 0x0000C024
		...
		// (get) Token: 0x06000299 RID: 665 RVA: 0x0000DE8A File Offset: 0x0000C08A
		...
		// (get) Token: 0x0600029A RID: 666 RVA: 0x0000DEB2 File Offset: 0x0000C0B2
		// (set) Token: 0x0600029B RID: 667 RVA: 0x0000DEBA File Offset: 0x0000C0BA
		...
		// Token: 0x0600029C RID: 668 RVA: 0x0000DEC4 File Offset: 0x0000C0C4
		...
		// Token: 0x0600029D RID: 669 RVA: 0x0000E1C4 File Offset: 0x0000C3C4
				...
				if (isArray)
				{
					...
					if (elementType.IsPrimitive)
					{
						...
						else if (elementType == typeof(uint))
						{
							...
							{
								string[] array5 = (string[])obj;
								int num5 = l;
								uint num6 = array4[l];
								array5[num5] = num6.ToString((IFormatProvider)invariantCulture.GetFormat(typeof(uint)));
							}
						}
						else if (elementType == typeof(ulong))
						{
							ulong[] array6 = (ulong[])val;
							...
							for (int m = 0; m < num7; m++)
							{
								...
								int num8 = m;
								ulong num9 = array6[m];
								array7[num8] = num9.ToString((IFormatProvider)invariantCulture.GetFormat(typeof(ulong)));
							}
						}
						else if (elementType == typeof(long))
						{
							long[] array8 = (long[])val;
							...
							for (int n = 0; n < num10; n++)
							{
								...
								int num11 = n;
								long num12 = array8[n];
								array9[num11] = num12.ToString((IFormatProvider)invariantCulture.GetFormat(typeof(long)));
							}
						}
						...
						{
							char[] array10 = (char[])val;
							int num13 = array10.Length;
							type = CimType.Char16;
							obj = new short[num13];
							for (int num14 = 0; num14 < num13; num14++)
							{
								((short[])obj)[num14] = ((IConvertible)array10[num14]).ToInt16(null);
							}
						}
					}
					...
					{
						Array array11 = (Array)val;
						int length = array11.Length;
						type = CimType.Object;
						obj = new IWbemClassObject_DoNotMarshal[length];
						for (int num15 = 0; num15 < length; num15++)
						{
							((IWbemClassObject_DoNotMarshal[])obj)[num15] = (IWbemClassObject_DoNotMarshal)Marshal.GetObjectForIUnknown(((ManagementBaseObject)array11.GetValue(num15)).wbemObject);
						}
					}
				}
