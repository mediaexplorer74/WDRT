...
namespace Microsoft.WindowsDeviceRecoveryTool.LenovoAdaptation
{
	...
	internal static class LenovoModels
	{
		...
		private static ModelInfo CreateNeoModelInfo()
		{
			...
			IdentificationInfo identificationInfo = new IdentificationInfo(new string[] { "503LV" });
			...
			return new ModelInfo(Resources.FriendlyName_Softbank_503LV, Resources.lenovo_softbank_503lv, detectionInfo, new VariantInfo[] { variantInfo });
		}
