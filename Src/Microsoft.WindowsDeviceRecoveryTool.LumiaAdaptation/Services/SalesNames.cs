...
namespace Microsoft.WindowsDeviceRecoveryTool.LumiaAdaptation.Services
{
	...
	public class SalesNames
	{
		...
		{
			return string.IsNullOrEmpty(packageName) ? string.Empty : SalesNames.NameForProductType(packageName.Split(new char[] { ' ' }).First<string>());
		}

		// Token: 0x06000062 RID: 98 RVA: 0x00004A0C File Offset: 0x00002C0C
		...
		private static readonly Dictionary<string, string> SalesNamesDictionary = new Dictionary<string, string>
		{
			...
			{ "RM-976", "Lumia 630" },
			{ "RM-977", "Lumia 630" },
			{ "RM-978", "Lumia 630 Dual SIM" },
			{ "RM-979", "Lumia 630 Dual SIM" },
			{ "RM-983", "Lumia 830" },
			{ "RM-984", "Lumia 830" },
			{ "RM-985", "Lumia 830" },
			{ "RM-994", "Lumia 1320" },
			...
			{ "RM-1045", "Lumia 930" },
			{ "RM-1049", "Lumia 830" },
			{ "RM-1062", "Lumia 640 XL LTE" },
			{ "RM-1064", "Lumia 640 XL LTE" },
			{ "RM-1066", "Lumia 640 XL" },
			{ "RM-1067", "Lumia 640 XL Dual SIM" },
			{ "RM-1068", "Lumia 435 Dual SIM" },
			{ "RM-1069", "Lumia 435 Dual SIM" },
			{ "RM-1070", "Lumia 435" },
			{ "RM-1071", "Lumia 435" },
			{ "RM-1072", "Lumia 640 LTE" },
			{ "RM-1073", "Lumia 640 LTE" },
			{ "RM-1075", "Lumia 640 LTE Dual SIM" },
			{ "RM-1077", "Lumia 640 Dual SIM" },
			{ "RM-1078", "Lumia 635" },
			{ "RM-1087", "Lumia 930" },
			{ "RM-1089", "Lumia 535" },
			{ "RM-1090", "Lumia 535 Dual SIM" },
			{ "RM-1091", "Lumia 535" },
			{ "RM-1092", "Lumia 535 Dual SIM" },
			{ "RM-1109", "Lumia 640 Dual SIM DTV" },
			{ "RM-1113", "Lumia 640 LTE Dual SIM" },
			{ "RM-1114", "Lumia 435 Dual SIM DTV" },
			{ "RM-1115", "Lumia 532 Dual SIM DTV" }
		};
	}
}
