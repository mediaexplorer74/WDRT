...
namespace Microsoft.Windows.Flashing.Platform
{
	...
	public class Logger : IDisposable
	{
		...
		internal unsafe Logger([In] FlashingPlatform Platform)
		{
			...
			this.m_Logger = calli(FlashingPlatform.ILogger* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ptr, (IntPtr)(*(*(int*)ptr)));
		...
		public unsafe void SetLogLevel(LogLevel Level)
		{
			...
			int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.LogLevel), logger, (LogLevel)Level, (IntPtr)(*(*(int*)logger)));
		}
		...
		public unsafe void Log(LogLevel Level, [In] string Message)
		{
			...
			*((ref cautoComFree<unsigned_u0020short_u0020const_u0020*>) + 4) = ptr;
			...
			{
				ILogger* logger = this.m_Logger;
				calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.LogLevel,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)*), logger, (LogLevel)Level, calli(System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoComFree<unsigned_u0020short_u0020const_u0020*>, (IntPtr)(*(cautoComFree<unsigned_u0020short_u0020const_u0020*> + 16))), (IntPtr)(*(*(int*)logger + 4)));
			}
			catch
			{
