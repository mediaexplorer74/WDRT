...
namespace Microsoft.WindowsDeviceRecoveryTool.HoneywellAdaptation
{
	...
	internal static class HoneywellModels
	{
		...
		private static ModelInfo CreateDolphin_75e_W10MModelInfo()
		{
			...
			IdentificationInfo identificationInfo = new IdentificationInfo(new string[] { "75eL0N" });
			...
			return new ModelInfo(Resources.FriendlyName_Dolphin75e_W10M, Resources.D75e_360Tour, detectionInfo, new VariantInfo[] { variantInfo });
		}
		...
		private static ModelInfo CreateDolphin_CT50_W10MModelInfo()
		{
			...
			IdentificationInfo identificationInfo = new IdentificationInfo(new string[] { "DolphinCT50" });
			...
			return new ModelInfo(Resources.FriendlyName_DolphinCT50_W10M, Resources.CT50_360Tour, detectionInfo, new VariantInfo[] { variantInfo, variantInfo2 });
		}
		...
		private static ModelInfo CreateDolphin_75e_WE8HModelIfo()
		{
			...
			return new ModelInfo(Resources.FriendlyName_Dolphin75e_WE8H, Resources.dolphin75_WE8H_large, detectionInfo, new VariantInfo[] { variantInfo });
		}
		...
		private static ModelInfo CreateDolphin_CT50_WE8HModelInfo()
		{
			...
			return new ModelInfo(Resources.FriendlyName_DolphinCT50_WE8H, Resources.dolphinct50_WE8H_large, detectionInfo, new VariantInfo[] { variantInfo });
		}
