	...
	public class ManagementClass : ManagementObject
	{
		...
		public ManagementObjectCollection GetInstances(EnumerationOptions options)
		{
			...
			try
			{
				...
				num = this.scope.GetSecuredIWbemServicesHandler(base.Scope.GetIWbemServices()).CreateInstanceEnum_(base.ClassName, enumerationOptions.Flags, enumerationOptions.GetContext(), ref enumWbemClassObject);
			}
			finally
			{
		...
		public ManagementObjectCollection GetSubclasses(EnumerationOptions options)
		{
			...
			{
				securityHandler = base.Scope.GetSecurityHandler();
				num = this.scope.GetSecuredIWbemServicesHandler(base.Scope.GetIWbemServices()).CreateClassEnum_(base.ClassName, enumerationOptions.Flags, enumerationOptions.GetContext(), ref enumWbemClassObject);
			}
			finally
			{
				if (securityHandler != null)
		...
		public ManagementObjectCollection GetRelatedClasses(string relatedClass, string relationshipClass, string relationshipQualifier, string relatedQualifier, string relatedRole, string thisRole, EnumerationOptions options)
		{
			...
			{
				securityHandler = base.Scope.GetSecurityHandler();
				num = this.scope.GetSecuredIWbemServicesHandler(base.Scope.GetIWbemServices()).ExecQuery_(relatedObjectQuery.QueryLanguage, relatedObjectQuery.QueryString, enumerationOptions.Flags, enumerationOptions.GetContext(), ref enumWbemClassObject);
			}
			finally
			{
				if (securityHandler != null)
		...
		public ManagementObjectCollection GetRelationshipClasses(string relationshipClass, string relationshipQualifier, string thisRole, EnumerationOptions options)
		{
			...
			{
				securityHandler = base.Scope.GetSecurityHandler();
				num = this.scope.GetSecuredIWbemServicesHandler(base.Scope.GetIWbemServices()).ExecQuery_(relationshipQuery.QueryLanguage, relationshipQuery.QueryString, enumerationOptions.Flags, enumerationOptions.GetContext(), ref enumWbemClassObject);
			}
			finally
			{
				if (securityHandler != null)
