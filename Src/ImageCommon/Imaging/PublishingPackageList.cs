...
namespace Microsoft.WindowsPhone.Imaging
{
	...
	public class PublishingPackageList
	{
		...
		public static void FixUpDuplicateFIPFeatures(PublishingPackageList sourcePpil)
		{
			...
			select grp)
			{
				...
				foreach (FeatureIdentifierPackage featureIdentifierPackage in source.ToList<FeatureIdentifierPackage>())
				{
					...
					if (num > 1)
					{
                        PublishingPackageList f8__locals1 =
							new PublishingPackageList();//PublishingPackageList().FeatureIdentifierPackages;//.<>c__DisplayClass39_0();


                        string text = featureIdentifierPackage.FeatureID + num;
						
						//RnD
						f8__locals1.orgFeatureIDWithFMID = 
							featureIdentifierPackage.FeatureIDWithFMID;
						...
						if ((predicate = f8__locals1.f9__2) == null)
						{
                            PublishingPackageList f8__locals2 = f8__locals1;
							predicate = (f8__locals2.f9__2 = 
								((FMFeatureGrouping grp) => 
								grp.AllFeatureIDWithFMIDs.Contains(
									f8__locals2.orgFeatureIDWithFMID, 
						...
						sourcePpil.Packages.AddRange(
							PublishingPackageList.GetRenamedDuplicateFeaturePackages(
								f8__locals1.orgFeatureIDWithFMID, text, sourcePpil));
						featureIdentifierPackage.FeatureID = text;
					}
				}
			}
        }//FixUpDuplicateFIPFeatures
		...
		{
            //PublishingPackageList.fDisplayClass40_0 
            RenamedDuplicateFeaturePackages f8__locals1 =
				new PublishingPackageList.RenamedDuplicateFeaturePackages();//c__DisplayClass40_0();


            f8__locals1.orgFeatureIDWithFMID = orgFeatureIDWithFMID;
			List<PublishingPackageInfo> list = new List<PublishingPackageInfo>();
			...
			{
				PublishingPackageList.RenamedDuplicateFeaturePackages f8__locals2 
					= f8__locals1;
				predicate = (f8__locals2.f9__0 = ((PublishingPackageInfo pkg)
					=> pkg.FeatureIDWithFMID.Equals(f8__locals2.orgFeatureIDWithFMID, 
		...
		public static PublishingPackageList ValidateAndLoad(string xmlFile, 
			IULogger logger)
		{
        ...
        private string orgFeatureIDWithFMID;
        private Func<FMFeatureGrouping, bool> f9__2;

        private class RenamedDuplicateFeaturePackages
        {
            internal string orgFeatureIDWithFMID;
            internal Func<PublishingPackageInfo, bool> f9__0;

            public RenamedDuplicateFeaturePackages()
            {
            }
        }
    }
