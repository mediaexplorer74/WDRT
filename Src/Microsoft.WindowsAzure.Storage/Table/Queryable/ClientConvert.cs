	...
	internal static class ClientConvert
	{
		...
		internal static object ChangeType(string propertyValue, Type propertyType)
		{
			...
			try
			{
				...
				{
				case 0:
					obj = XmlConvert.ToBoolean(propertyValue);
					break;
				case 1:
					obj = XmlConvert.ToByte(propertyValue);
					break;
				case 2:
					obj = Convert.FromBase64String(propertyValue);
					break;
				case 3:
					obj = XmlConvert.ToChar(propertyValue);
					break;
				case 4:
					obj = propertyValue.ToCharArray();
					break;
				case 5:
					obj = XmlConvert.ToDateTime(propertyValue, XmlDateTimeSerializationMode.RoundtripKind);
					break;
				case 6:
					obj = XmlConvert.ToDateTimeOffset(propertyValue);
					break;
				case 7:
					obj = XmlConvert.ToDecimal(propertyValue);
					break;
				case 8:
					obj = XmlConvert.ToDouble(propertyValue);
					break;
				case 9:
					obj = new Guid(propertyValue);
					break;
				case 10:
					obj = XmlConvert.ToInt16(propertyValue);
					break;
				case 11:
					obj = XmlConvert.ToInt32(propertyValue);
					break;
				case 12:
					obj = XmlConvert.ToInt64(propertyValue);
					break;
				case 13:
					obj = XmlConvert.ToSingle(propertyValue);
					break;
				case 14:
					obj = propertyValue;
					break;
				case 15:
					obj = XmlConvert.ToSByte(propertyValue);
					break;
				case 16:
					obj = XmlConvert.ToTimeSpan(propertyValue);
					break;
				case 17:
					obj = Type.GetType(propertyValue, true);
					break;
				case 18:
					obj = XmlConvert.ToUInt16(propertyValue);
					break;
				case 19:
					obj = XmlConvert.ToUInt32(propertyValue);
					break;
				case 20:
					obj = XmlConvert.ToUInt64(propertyValue);
					break;
				case 21:
					obj = ClientConvert.CreateUri(propertyValue, UriKind.RelativeOrAbsolute);
					break;
				case 22:
					obj = ((0 < propertyValue.Length) ? XDocument.Parse(propertyValue) : new XDocument());
					break;
				case 23:
					obj = XElement.Parse(propertyValue);
					break;
				case 24:
					obj = Activator.CreateInstance(ClientConvert.KnownTypes[24], new object[] { Convert.FromBase64String(propertyValue) });
					break;
				default:
					obj = propertyValue;
					break;
		...
		{
			byte[] array = (byte[])binaryValue.GetType().InvokeMember("ToArray", BindingFlags.Instance | BindingFlags.Public | BindingFlags.InvokeMethod, null, binaryValue, null, null, CultureInfo.InvariantCulture, null);
			return WebConvert.TryKeyPrimitiveToString(array, out result);
		}
		...
		internal static string GetEdmType(Type propertyType)
		{
			...
			case 19:
			case 20:
				throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, "Can't cast to unsupported type '{0}'", new object[] { propertyType.Name }));
			case 7:
				return "Edm.Decimal";
			case 8:
				return "Edm.Double";
