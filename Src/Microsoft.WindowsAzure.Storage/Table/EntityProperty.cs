...
namespace Microsoft.WindowsAzure.Storage.Table
{
	...
	public sealed class EntityProperty : IEquatable<EntityProperty>
	{
		...
		{
			EntityProperty entityProperty = obj as EntityProperty;
			return this.Equals(entityProperty);
		}
		...
		private void EnforceType(EdmType requestedType)
		{
			...
			{
				throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "Cannot return {0} type for a {1} typed property.", new object[] { requestedType, this.PropertyType }));
			}
		}
