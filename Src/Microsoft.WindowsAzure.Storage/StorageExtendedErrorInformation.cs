...
namespace Microsoft.WindowsAzure.Storage
{
	...
	public sealed class StorageExtendedErrorInformation
	{
		...
		public static StorageExtendedErrorInformation ReadFromStream(Stream inputStream)
		{
			...
			StorageExtendedErrorInformation storageExtendedErrorInformation2;
			try
			{
				...
				storageExtendedErrorInformation2 = storageExtendedErrorInformation;
			}
			catch (XmlException)
			{
				storageExtendedErrorInformation2 = null;
			}
			return storageExtendedErrorInformation2;
		}
		...
		public static StorageExtendedErrorInformation ReadFromStreamUsingODataLib(Stream inputStream, HttpWebResponse response, string contentType)
		{
			...
			HttpResponseAdapterMessage httpResponseAdapterMessage = new HttpResponseAdapterMessage(response, inputStream, contentType);
			return StorageExtendedErrorInformation.ReadAndParseExtendedError(httpResponseAdapterMessage);
		}
		...
		public static StorageExtendedErrorInformation ReadDataServiceResponseFromStream(Stream inputStream, IDictionary<string, string> responseHeaders, string contentType)
		{
			...
			DataServicesResponseAdapterMessage dataServicesResponseAdapterMessage = new DataServicesResponseAdapterMessage(responseHeaders, inputStream, contentType);
			return StorageExtendedErrorInformation.ReadAndParseExtendedError(dataServicesResponseAdapterMessage);
		}
