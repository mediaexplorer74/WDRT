...
namespace Microsoft.WindowsPhone.ImageUpdate.Tools.Common
{
	...
	public class ImagePartitionCollection : Collection<ImagePartition>
	{
		...
		{
			RelatedObjectQuery relatedObjectQuery = new RelatedObjectQuery(string.Format("\\\\.\\root\\cimv2:Win32_DiskDrive.DeviceID='{0}'", deviceId), "Win32_DiskPartition");
			ManagementObjectSearcher managementObjectSearcher = new ManagementObjectSearcher(relatedObjectQuery);
