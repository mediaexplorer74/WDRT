...
namespace Microsoft.WindowsAzure.Storage.Table.Queryable
{
	...
	internal static class TypeSystem
	{
		...
		static TypeSystem()
		{
			TypeSystem.StaticExpressionMethodMap.Add(typeof(string).GetMethod("Contains", new Type[] { typeof(string) }), "substringof");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(string).GetMethod("EndsWith", new Type[] { typeof(string) }), "endswith");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(string).GetMethod("StartsWith", new Type[] { typeof(string) }), "startswith");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(string).GetMethod("IndexOf", new Type[] { typeof(string) }), "indexof");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(string).GetMethod("Replace", new Type[]
			{
				typeof(string),
				typeof(string)
			}), "replace");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(string).GetMethod("Substring", new Type[] { typeof(int) }), "substring");
			...
			TypeSystem.StaticExpressionMethodMap.Add(typeof(Math).GetMethod("Round", new Type[] { typeof(double) }), "round");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(Math).GetMethod("Round", new Type[] { typeof(decimal) }), "round");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(Math).GetMethod("Floor", new Type[] { typeof(double) }), "floor");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(Math).GetMethod("Floor", new Type[] { typeof(decimal) }), "floor");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(Math).GetMethod("Ceiling", new Type[] { typeof(double) }), "ceiling");
			TypeSystem.StaticExpressionMethodMap.Add(typeof(Math).GetMethod("Ceiling", new Type[] { typeof(decimal) }), "ceiling");
