...
namespace Microsoft.WindowsAzure.Storage.Shared.Protocol
{
	...
	public sealed class CorsRule
	{
		...
		public IList<string> AllowedOrigins
		{
			...
			{
				IList<string> list;
				if ((list = this.allowedOrigins) == null)
				{
					list = (this.allowedOrigins = new List<string>());
				}
				return list;
			}
			set
		...
		public IList<string> ExposedHeaders
		{
			...
			{
				IList<string> list;
				if ((list = this.exposedHeaders) == null)
				{
					list = (this.exposedHeaders = new List<string>());
				}
				return list;
			}
			set
		...
		public IList<string> AllowedHeaders
		{
			...
			{
				IList<string> list;
				if ((list = this.allowedHeaders) == null)
				{
					list = (this.allowedHeaders = new List<string>());
				}
				return list;
			}
			set
