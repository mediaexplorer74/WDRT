...
namespace System.Deployment.Internal.CodeSigning
{
	...
	internal class SignedCmiManifest2
	{
		...
		// Token: 0x06000079 RID: 121 RVA: 0x00004053 File Offset: 0x00002253
		...
		// Token: 0x0600007A RID: 122 RVA: 0x00004077 File Offset: 0x00002277
		internal void Sign(CmiManifestSigner2 signer)
		{
			this.Sign(signer, null);
		}

		// Token: 0x0600007B RID: 123 RVA: 0x00004084 File Offset: 0x00002284
		internal void Sign(CmiManifestSigner2 signer, string timeStampUrl)
		{
			...
			if (signer.Certificate != null)
			{
				...
				xmlDocument = SignedCmiManifest2.CreateLicenseDom(signer, this.ExtractPrincipalFromManifest(), SignedCmiManifest2.ComputeHashFromManifest(this.m_manifestDom, this.m_useSha256));
				SignedCmiManifest2.AuthenticodeSignLicenseDom(xmlDocument, signer, timeStampUrl, this.m_useSha256);
			}
			SignedCmiManifest2.StrongNameSignManifestDom(this.m_manifestDom, xmlDocument, signer, this.m_useSha256);
		}

		// Token: 0x0600007C RID: 124 RVA: 0x0000413C File Offset: 0x0000233C
		internal void Verify(CmiManifestVerifyFlags verifyFlags)
		{
			...
			string text = this.VerifyPublicKeyToken();
			this.m_strongNameSignerInfo = new CmiStrongNameSignerInfo(-2146762485, text);
			...
			bool flag = manifestSignedXml.CheckSignatureReturningKey(out asymmetricAlgorithm);
		...
		// (get) Token: 0x0600007D RID: 125 RVA: 0x0000424C File Offset: 0x0000244C
		...
		// (get) Token: 0x0600007E RID: 126 RVA: 0x00004254 File Offset: 0x00002454
		...
		// Token: 0x0600007F RID: 127 RVA: 0x0000425C File Offset: 0x0000245C
		...
		// Token: 0x06000080 RID: 128 RVA: 0x00004444 File Offset: 0x00002644
		private void VerifyLicenseNew(CmiManifestVerifyFlags verifyFlags)
		{
			...
			string text2;
			string text3;
			if (!this.GetManifestInformation(xmlElement, xmlNamespaceManager, out text, out text2, out text3))
			{
				this.m_authenticodeSignerInfo.ErrorCode = -2146762749;
				throw new CryptographicException(-2146762749);
			}
			this.m_authenticodeSignerInfo.Hash = text;
			this.m_authenticodeSignerInfo.Description = text2;
			this.m_authenticodeSignerInfo.DescriptionUrl = text3;
			DateTime dateTime;
			bool flag = (this.OverrideTimestampImprovements(xmlNamespaceManager) ? this.VerifySignatureTimestamp(xmlElement2, xmlNamespaceManager, out dateTime) : this.VerifySignatureTimestampNew(xmlElement2, xmlNamespaceManager, out dateTime));
			bool flag2 = false;
			if (flag)
			{
			...
			x509Chain.ChainPolicy.VerificationTime = dateTime;
			if (flag && flag2)
			{
		...
		{
			string text = "Id";
			if (!signatureNode.HasAttribute(text))
			{
				text = "id";
				if (!signatureNode.HasAttribute(text))
				{
			...
			string attribute = signatureNode.GetAttribute(text);
		...
		// Token: 0x06000083 RID: 131 RVA: 0x00004C18 File Offset: 0x00002E18
		private bool GetManifestInformation(XmlElement licenseNode, XmlNamespaceManager nsm, out string hash, out string description, out string url)
		{
			...
			{
				if (255 == SignedCmiManifest2.HexToByte(c))
				{
					return false;
				}
			}
		...
		// Token: 0x06000084 RID: 132 RVA: 0x00004CDC File Offset: 0x00002EDC
		...
		// Token: 0x06000086 RID: 134 RVA: 0x00005324 File Offset: 0x00003524
		private DateTime VerifyRFC3161Timestamp(byte[] base64DecodedMessage, byte[] base64DecodedSignatureValue)
		{
			...
			try
			{
				...
				try
				{
					dateTime = this.ReadRfc3161TimestampTokenTime(zero);
				}
				catch (Exception ex)
				{
		...
		// Token: 0x06000087 RID: 135 RVA: 0x000053EC File Offset: 0x000035EC
		...
		// Token: 0x06000088 RID: 136 RVA: 0x00005454 File Offset: 0x00003654
		...
		// Token: 0x0600008A RID: 138 RVA: 0x00005588 File Offset: 0x00003788
		...
		// Token: 0x0600008B RID: 139 RVA: 0x00005620 File Offset: 0x00003820
		...
		// Token: 0x0600008C RID: 140 RVA: 0x00005674 File Offset: 0x00003874
		...
		// Token: 0x0600008D RID: 141 RVA: 0x00005780 File Offset: 0x00003980
		...
		// Token: 0x0600008E RID: 142 RVA: 0x0000588C File Offset: 0x00003A8C
		...
		// Token: 0x0600008F RID: 143 RVA: 0x000059A4 File Offset: 0x00003BA4
		...
		// Token: 0x06000090 RID: 144 RVA: 0x00005B60 File Offset: 0x00003D60
		...
		// Token: 0x06000092 RID: 146 RVA: 0x00005CE0 File Offset: 0x00003EE0
		...
		// Token: 0x06000093 RID: 147 RVA: 0x00005D58 File Offset: 0x00003F58
		...
		// Token: 0x06000094 RID: 148 RVA: 0x00005EA8 File Offset: 0x000040A8
		...
		// Token: 0x06000095 RID: 149 RVA: 0x00005F1C File Offset: 0x0000411C
		...
		// Token: 0x06000096 RID: 150 RVA: 0x00006024 File Offset: 0x00004224
		...
		// Token: 0x06000097 RID: 151 RVA: 0x0000618C File Offset: 0x0000438C
		...
		// Token: 0x06000098 RID: 152 RVA: 0x00006314 File Offset: 0x00004514
		private unsafe static string ObtainRFC3161Timestamp(string timeStampUrl, string signatureValue, bool useSha256)
		{
			...
			string text2 = (useSha256 ? "2.16.840.1.101.3.4.2.1" : "1.3.14.3.2.26");
			IntPtr zero = IntPtr.Zero;
			IntPtr zero2 = IntPtr.Zero;
			IntPtr zero3 = IntPtr.Zero;
			try
			{
				...
				try
				{
					...
					if (!Win32.CryptRetrieveTimeStamp(timeStampUrl, 0U, 60000, text2, ref crypt_TIMESTAMP_PARA, array, array.Length, ref zero, ref zero2, ref zero3))
					{
						throw new CryptographicException(Marshal.GetLastWin32Error());
					}
				}
		...
		// Token: 0x06000099 RID: 153 RVA: 0x000064B8 File Offset: 0x000046B8
		private unsafe static void TimestampSignedLicenseDom(XmlDocument licenseDom, string timeStampUrl, bool useSha256)
		{
			...
			try
			{
				...
				string innerText = xmlElement.InnerText;
				text = SignedCmiManifest2.ObtainRFC3161Timestamp(timeStampUrl, innerText, useSha256);
			}
			catch
			{
				Win32.CRYPT_DATA_BLOB crypt_DATA_BLOB = default(Win32.CRYPT_DATA_BLOB);
		...
		// Token: 0x0600009A RID: 154 RVA: 0x00006650 File Offset: 0x00004850
		...
		// Token: 0x0600009B RID: 155 RVA: 0x000067CC File Offset: 0x000049CC
		...
		// Token: 0x0600009C RID: 156 RVA: 0x00006834 File Offset: 0x00004A34
		...
		// Token: 0x0600009E RID: 158 RVA: 0x00006890 File Offset: 0x00004A90
