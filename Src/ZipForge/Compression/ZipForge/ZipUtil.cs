...
namespace ComponentAce.Compression.ZipForge
{
	...
	internal class ZipUtil : CompressionUtils
	{
		...
		public static readonly byte[] PPM_MO = new byte[] { 2, 3, 4, 5, 7, 8, 10, 13, 16 };

		// Token: 0x0400042E RID: 1070
		public static readonly byte[] PPM_SA = new byte[] { 2, 3, 7, 16, 22, 25, 40, 100, 100 };
		...
		internal static readonly uint[] Crc32Table = new uint[]
		{
			...
			1567103746U, 711928724U, 3020668471U, 3272380065U, 1510334235U, 755167117U, 1953656656U, 1936617321U, 1886339872U, 1734963833U,
			673215592U, 824191331U, 540621113U, 1210087778U, 1852139361U, 1684361760U, 1851878756U, 1874568046U
		};
	}
}
