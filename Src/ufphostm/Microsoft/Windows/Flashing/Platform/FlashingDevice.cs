...
namespace Microsoft.Windows.Flashing.Platform
{
	...
	public class FlashingDevice : ConnectedDevice
	{
		...
		/*
        public unsafe static class m_Platform
        {
            internal static unsafe IFlashingPlatform* Native;
        }
		*/

        // Token: 0x06000147 RID: 327 RVA: 0x00013678 File Offset: 0x00012A78
        public unsafe FlashingDevice(IFlashingDevice* Device, [In] FlashingPlatform Platform) : base(null, Platform)
		{
			try
			{
		...
		public new unsafe IFlashingDevice* Native
		{
			get
			{
        ...
        public unsafe void UnFlashingDevice()//!FlashingDevice()
        {
        ...
        public unsafe object calli(int int32, object value1, object value2, IFlashingDevice* ptr, object value3)
        {
        ...
        public unsafe string GetDeviceFriendlyName()
		{
			IFlashingDevice* device = this.m_Device;
			ushort* value;
			int num = -1;//calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)**), device, ref value, *(*(int*)device + 24));
			if (num < 0)
			{
				...
				try
				{
					IFlashingPlatform* native = this.m_Platform.Native;//this.m_Platform.Native;
                    if (false)//(calli(FlashingPlatform.ILogger* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), native, *(*(int*)native)))
					{
						IFlashingPlatform* native2 = this.m_Platform.Native;//this.m_Platform.Native;
						int num2 = -1;//calli(FlashingPlatform.ILogger* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), native2, *(*(int*)native2));
					...
					IntPtr ptr = default;//(IntPtr)calli(System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>, *(cautoDeleteArray<unsigned_u0020short_u0020const_u0020> + 16));
			...
			return null;//Marshal.PtrToStringUni((IntPtr)((void*)value));
		...
		public unsafe Guid GetDeviceUniqueID()
		{
			IFlashingDevice* device = this.m_Device;
			//_GUID a;
			int num = -1;// calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,_GUID*), device, ref a, *(*(int*)device + 28));
			if (num < 0)
			{
				//CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
				...
				try
				{
					IFlashingPlatform* native = this.m_Platform.Native; // this.
					if (false)//(calli(FlashingPlatform.ILogger* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), native, *(*(int*)native)))
					{
			...
			Guid result = default;//new Guid(a, *(ref a + 4), *(ref a + 6), *(ref a + 8), *(ref a + 9), *(ref a + 10), *(ref a + 11), *(ref a + 12), *(ref a + 13), *(ref a + 14), *(ref a + 15));
			return result;
			//try
			//{
			//}
		...
		public unsafe Guid GetDeviceSerialNumber()
		{
			IFlashingDevice* device = this.m_Device;
			//_GUID a;
			int num = -1;//calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,_GUID*), device, ref a, *(*(int*)device + 32));
			if (num < 0)
			{
				//CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
		...
		public unsafe void WriteWim([In] string WimPath, GenericProgress Progress)
		{
			...
			try
			{
				CGenericProgressShim* ptr2 = default;//<Module>.@new(8U);
				...
				try
				{
					if (ptr2 != null)
					{
						...
						*(int*)(ptr2 + 4 / sizeof(CGenericProgressShim)) = default;//((IntPtr)GCHandle.Alloc(Progress)).ToPointer();
						ptr3 = ptr2;
					}
					else
					{
						ptr3 = (CGenericProgressShim*)0;
					}
				}
				catch
				{
				...
				{
					IFlashingDevice* device = this.m_Device;
					int num = -1;//calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)*,FlashingPlatform.IGenericProgress*), device, calli(System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoComFree<unsigned_u0020short_u0020const_u0020*>, *(cautoComFree<unsigned_u0020short_u0020const_u0020*> + 16)), calli(CGenericProgressShim* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDelete<CGenericProgressShim_u0020*>, *(cautoDelete<CGenericProgressShim_u0020*> + 16)), *(*(int*)device + 36));
					if (num < 0)
					{
		...
		{
			IFlashingDevice* device = this.m_Device;
			int num = -1;//calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), device, *(*(int*)device + 40));
			//CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
			if (num < 0)
			{
		...
		{
			IFlashingDevice* device = this.m_Device;
			int num = -1;// calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), device, *(*(int*)device + 44));
			//CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
			if (num < 0)
			{
		...
		{
			IFlashingDevice* device = null;//this.m_Device;
			int num = -1;// calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), device, *(*(int*)device + 48));
			//CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
			if (num < 0)
			{
			...
			try
			{
				...
				if (num < 0)
				{
					...
					try
					{
						...
						IntPtr ptr2 = default;//(IntPtr)calli(System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>, *(cautoDeleteArray<unsigned_u0020short_u0020const_u0020> + 16));
		...
		public unsafe void FlashFFUFile([In] string FFUFilePath, FlashFlags Flags, GenericProgress Progress, HandleRef CancelEvent)
		{
			...
			try
			{
				...
				try
				{
					if (ptr2 != null)
					{
						*(int*)(ptr2) = default;//ref <Module>.??_7CGenericProgressShim@@6B@;
						*(int*)(ptr2 + 4 / sizeof(CGenericProgressShim)) = (int)((IntPtr)GCHandle.Alloc(Progress)).ToPointer();
						ptr3 = ptr2;
					}
					else
					{
				...
				try
				{
					...
					if (num < 0)
					{
						...
						try
						{
							IFlashingPlatform* native = null;//this.m_Platform.Native;
							if (false)//(calli(FlashingPlatform.ILogger* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), native, *(*(int*)native)))
							{
								IFlashingPlatform* native2 = null;//this.m_Platform.Native;
								int num2 = -1;// calli(FlashingPlatform.ILogger* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), native2, *(*(int*)native2));
								//calli(System.Void modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,FlashingPlatform.LogLevel,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)*), num2, 2, calli(System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>, *(cautoDeleteArray<unsigned_u0020short_u0020const_u0020> + 16)), *(*num2 + 4));
							}
							IntPtr ptr4 = default;//(IntPtr)calli(System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>, *(cautoDeleteArray<unsigned_u0020short_u0020const_u0020> + 16));
		...
		protected void Dispose([MarshalAs(UnmanagedType.U1)] bool A_0)
		{
			if (A_0)
			{
				try
				{
					this.UnFlashingDevice();//~FlashingDevice();
					return;
				}
				finally
				{
