...
namespace Microsoft.WindowsPhone.ImageUpdate.Tools.Common
{
	...
	public class NoSuchArgumentException : ParseException
	{
		...
		public NoSuchArgumentException(string type, string id)
			: base(string.Format(CultureInfo.InvariantCulture, "The {0} '{1}' was not defined", new object[] { type, id }))
		{
		}

		// Token: 0x06000080 RID: 128 RVA: 0x000057F8 File Offset: 0x000039F8
		public NoSuchArgumentException(string id)
			: base(string.Format(CultureInfo.InvariantCulture, "The '{0}' was not defined", new object[] { id }))
		{
		}
