...
namespace Microsoft.Windows.Flashing.Platform
{
	...
	public class FlashingDevice : ConnectedDevice
	{
		...
		public unsafe string GetDeviceFriendlyName()
		{
			IFlashingDevice* device = this.m_Device;
			ushort* ptr;
			int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)**), device, &ptr, (IntPtr)(*(*(int*)device + 24)));
			if (num < 0)
			{
				CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
				*((ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>) + 4) = <Module>.UfphNativeStrFormat((ushort*)(&<Module>.??_C@_1EG@CCFOHDEM@?$AAF?$AAa?$AAi?$AAl?$AAe?$AAd?$AA?5?$AAt?$AAo?$AA?5?$AAg?$AAe?$AAt?$AA?5?$AAd?$AAe?$AAv?$AAi?$AAc?$AAe?$AA?5?$AAf?$AAr?$AAi?$AAe?$AAn?$AAd?$AAl?$AAy?$AA?5?$AAn?$AAa@), __arglist());
		...
		public unsafe Guid GetDeviceUniqueID()
		{
			IFlashingDevice* device = this.m_Device;
			_GUID guid;
			int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,_GUID*), device, &guid, (IntPtr)(*(*(int*)device + 28)));
			if (num < 0)
			{
				CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
				*((ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>) + 4) = <Module>.UfphNativeStrFormat((ushort*)(&<Module>.??_C@_1DO@FGPACCJK@?$AAF?$AAa?$AAi?$AAl?$AAe?$AAd?$AA?5?$AAt?$AAo?$AA?5?$AAg?$AAe?$AAt?$AA?5?$AAd?$AAe?$AAv?$AAi?$AAc?$AAe?$AA?5?$AAu?$AAn?$AAi?$AAq?$AAu?$AAe?$AA?5?$AAI?$AAD?$AA?$AA@), __arglist());
				cautoDeleteArray<unsigned_u0020short_u0020const_u0020> = ref <Module>.??_7?$CAutoDeleteArray@$$CBG@RAII@@6B@;
				try
				{
					IFlashingPlatform* native = this.m_Platform.Native;
		...
		public unsafe Guid GetDeviceSerialNumber()
		{
			IFlashingDevice* device = this.m_Device;
			_GUID guid;
			int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,_GUID*), device, &guid, (IntPtr)(*(*(int*)device + 32)));
			if (num < 0)
			{
				CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
				*((ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>) + 4) = <Module>.UfphNativeStrFormat((ushort*)(&<Module>.??_C@_1EG@FNHIMFAE@?$AAF?$AAa?$AAi?$AAl?$AAe?$AAd?$AA?5?$AAt?$AAo?$AA?5?$AAg?$AAe?$AAt?$AA?5?$AAd?$AAe?$AAv?$AAi?$AAc?$AAe?$AA?5?$AAs?$AAe?$AAr?$AAi?$AAa?$AAl?$AA?5?$AAn?$AAu?$AAm?$AAb@), __arglist());
				cautoDeleteArray<unsigned_u0020short_u0020const_u0020> = ref <Module>.??_7?$CAutoDeleteArray@$$CBG@RAII@@6B@;
				try
				{
					IFlashingPlatform* native = this.m_Platform.Native;
			...
			*((ref cautoComFree<unsigned_u0020short_u0020const_u0020*>) + 4) = ptr;
			...
			try
			{
				...
				*((ref cautoDelete<CGenericProgressShim_u0020*>) + 4) = ptr3;
				...
				{
					IFlashingDevice* device = this.m_Device;
					int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)*,FlashingPlatform.IGenericProgress*), device, calli(System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoComFree<unsigned_u0020short_u0020const_u0020*>, (IntPtr)(*(cautoComFree<unsigned_u0020short_u0020const_u0020*> + 16))), calli(CGenericProgressShim* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDelete<CGenericProgressShim_u0020*>, (IntPtr)(*(cautoDelete<CGenericProgressShim_u0020*> + 16))), (IntPtr)(*(*(int*)device + 36)));
					if (num < 0)
					{
						*((ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>) + 4) = <Module>.UfphNativeStrFormat((ushort*)(&<Module>.??_C@_1CI@ECIEBNIH@?$AAF?$AAa?$AAi?$AAl?$AAe?$AAd?$AA?5?$AAt?$AAo?$AA?5?$AAw?$AAr?$AAi?$AAt?$AAe?$AA?5?$AAW?$AAI?$AAM?$AA?$AA@), __arglist());
						cautoDeleteArray<unsigned_u0020short_u0020const_u0020> = ref <Module>.??_7?$CAutoDeleteArray@$$CBG@RAII@@6B@;
						try
						{
							IFlashingPlatform* native = this.m_Platform.Native;
		...
		{
			IFlashingDevice* device = this.m_Device;
			int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), device, (IntPtr)(*(*(int*)device + 40)));
			CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
			if (num < 0)
			{
				*((ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>) + 4) = <Module>.UfphNativeStrFormat((ushort*)(&<Module>.??_C@_1DA@FFAALIKO@?$AAF?$AAa?$AAi?$AAl?$AAe?$AAd?$AA?5?$AAt?$AAo?$AA?5?$AAs?$AAk?$AAi?$AAp?$AA?5?$AAt?$AAr?$AAa?$AAn?$AAs?$AAf?$AAe?$AAr?$AA?$AA@), __arglist());
				cautoDeleteArray<unsigned_u0020short_u0020const_u0020> = ref <Module>.??_7?$CAutoDeleteArray@$$CBG@RAII@@6B@;
				try
				{
					IFlashingPlatform* native = this.m_Platform.Native;
		...
		{
			IFlashingDevice* device = this.m_Device;
			int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), device, (IntPtr)(*(*(int*)device + 44)));
			CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
			if (num < 0)
			{
				*((ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>) + 4) = <Module>.UfphNativeStrFormat((ushort*)(&<Module>.??_C@_1CC@KCIGDDEL@?$AAF?$AAa?$AAi?$AAl?$AAe?$AAd?$AA?5?$AAt?$AAo?$AA?5?$AAr?$AAe?$AAb?$AAo?$AAo?$AAt?$AA?$AA@), __arglist());
				cautoDeleteArray<unsigned_u0020short_u0020const_u0020> = ref <Module>.??_7?$CAutoDeleteArray@$$CBG@RAII@@6B@;
				try
				{
					IFlashingPlatform* native = this.m_Platform.Native;
		...
		{
			IFlashingDevice* device = this.m_Device;
			int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), device, (IntPtr)(*(*(int*)device + 48)));
			CAutoDeleteArray<unsigned\u0020short\u0020const\u0020> cautoDeleteArray<unsigned_u0020short_u0020const_u0020>;
			if (num < 0)
			{
				*((ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>) + 4) = <Module>.UfphNativeStrFormat((ushort*)(&<Module>.??_C@_1EE@BNENPODH@?$AAF?$AAa?$AAi?$AAl?$AAe?$AAd?$AA?5?$AAt?$AAo?$AA?5?$AAe?$AAn?$AAt?$AAe?$AAr?$AA?5?$AAm?$AAa?$AAs?$AAs?$AA?5?$AAs?$AAt?$AAo?$AAr?$AAa?$AAg?$AAe?$AA?5?$AAm?$AAo?$AAd@), __arglist());
				cautoDeleteArray<unsigned_u0020short_u0020const_u0020> = ref <Module>.??_7?$CAutoDeleteArray@$$CBG@RAII@@6B@;
				try
				{
					IFlashingPlatform* native = this.m_Platform.Native;
		...
		public unsafe void SetBootMode(uint BootMode, string ProfileName)
		{
			...
			*((ref cautoComFree<unsigned_u0020short_u0020const_u0020*>) + 4) = ptr;
			...
			{
				IFlashingDevice* device = this.m_Device;
				int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.UInt32,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)*), device, BootMode, calli(System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoComFree<unsigned_u0020short_u0020const_u0020*>, (IntPtr)(*(cautoComFree<unsigned_u0020short_u0020const_u0020*> + 16))), (IntPtr)(*(*(int*)device + 52)));
				if (num < 0)
				{
					*((ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>) + 4) = <Module>.UfphNativeStrFormat((ushort*)(&<Module>.??_C@_1DA@MBNNDMOJ@?$AAF?$AAa?$AAi?$AAl?$AAe?$AAd?$AA?5?$AAt?$AAo?$AA?5?$AAs?$AAe?$AAt?$AA?5?$AAb?$AAo?$AAo?$AAt?$AA?5?$AAm?$AAo?$AAd?$AAe?$AA?$AA@), __arglist());
					cautoDeleteArray<unsigned_u0020short_u0020const_u0020> = ref <Module>.??_7?$CAutoDeleteArray@$$CBG@RAII@@6B@;
					try
					{
						IFlashingPlatform* native = this.m_Platform.Native;
			...
			try
			{
				...
				*((ref cautoDelete<CGenericProgressShim_u0020*>) + 4) = ptr3;
				...
				try
				{
					...
					IFlashingDevice* device = this.m_Device;
					int num = calli(System.Int32 modopt(System.Runtime.CompilerServices.IsLong) modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr,System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)*,System.UInt32 modopt(System.Runtime.CompilerServices.IsLong),FlashingPlatform.IGenericProgress*,System.Void*), device, calli(System.UInt16 modopt(System.Runtime.CompilerServices.IsConst)* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoComFree<unsigned_u0020short_u0020const_u0020*>, (IntPtr)(*(cautoComFree<unsigned_u0020short_u0020const_u0020*> + 16))), Flags, calli(CGenericProgressShim* modopt(System.Runtime.CompilerServices.CallConvThiscall)(System.IntPtr), ref cautoDelete<CGenericProgressShim_u0020*>, (IntPtr)(*(cautoDelete<CGenericProgressShim_u0020*> + 16))), (void*)handle, (IntPtr)(*(*(int*)device + 56)));
					if (num < 0)
					{
						*((ref cautoDeleteArray<unsigned_u0020short_u0020const_u0020>) + 4) = <Module>.UfphNativeStrFormat((ushort*)(&<Module>.??_C@_1DC@PGNKAIIP@?$AAF?$AAa?$AAi?$AAl?$AAe?$AAd?$AA?5?$AAt?$AAo?$AA?5?$AAf?$AAl?$AAa?$AAs?$AAh?$AA?5?$AAF?$AAF?$AAU?$AA?5?$AAf?$AAi?$AAl?$AAe?$AA?$AA@), __arglist());
						cautoDeleteArray<unsigned_u0020short_u0020const_u0020> = ref <Module>.??_7?$CAutoDeleteArray@$$CBG@RAII@@6B@;
						try
						{
							IFlashingPlatform* native = this.m_Platform.Native;
