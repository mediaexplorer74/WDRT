	...
	public class DevicePaths
	{
		...
		public static string GetRegistryHiveFilePath(SystemRegistryHiveFiles hiveType, bool isUefiBoot = true)
		{
			...
			case SystemRegistryHiveFiles.SYSTEM:
				text = Path.Combine(DevicePaths.RegistryHivePath, "SYSTEM");
				break;
			case SystemRegistryHiveFiles.SOFTWARE:
				text = Path.Combine(DevicePaths.RegistryHivePath, "SOFTWARE");
				break;
			case SystemRegistryHiveFiles.DEFAULT:
				text = Path.Combine(DevicePaths.RegistryHivePath, "DEFAULT");
				break;
			case SystemRegistryHiveFiles.DRIVERS:
				text = Path.Combine(DevicePaths.RegistryHivePath, "DRIVERS");
				break;
			case SystemRegistryHiveFiles.SAM:
				text = Path.Combine(DevicePaths.RegistryHivePath, "SAM");
				break;
			case SystemRegistryHiveFiles.SECURITY:
				text = Path.Combine(DevicePaths.RegistryHivePath, "SECURITY");
				break;
			case SystemRegistryHiveFiles.BCD:
				text = Path.Combine(DevicePaths.GetBCDHivePath(isUefiBoot), "BCD");
				break;
			}
			return text;
		}
